...
public class SSOAuthenticationFilter implements Filter, CallbackHandler
{
        ...
        throws IOException, ServletException
    {
        ...
        /////////////////////////// beCPG : work around to accept invitation since page is always null
        
//        logger.debug("###page: " + page);
//        if(page != null){
//        	logger.debug("###page.getAuthentication(): " + page.getAuthentication());
//        }        
        
        String ACCEPT_INVITE_PATH_INFORMATION = "/accept-invite";
        if (PAGE_SERVLET_PATH.equals(req.getServletPath())
                && (ACCEPT_INVITE_PATH_INFORMATION.equals(req.getPathInfo())))
        {
            if (debug)
                logger.debug("accept-invite page requested, chaining ...");
        ...
        /////////////////////////// beCPG : end of work around to accept invitation
