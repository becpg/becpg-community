...
public class TypeFormProcessor extends ContentModelFormProcessor<TypeDefinition, NodeRef>
{
    ...
    public static final String ASSOCIATION = "alf_association";
    ...
    protected NodeRef createNode(TypeDefinition typeDef, FormData data)
    {
        ...
        if (data != null)
        {
            ...
            FieldData association = data.getFieldData(ASSOCIATION);
            
            QName assocTypeQname = ContentModel.ASSOC_CONTAINS;
            
            if (association != null) 
            { 
            	  if (((String)association.getValue()).startsWith("{"))
                  {
            		  assocTypeQname = QName.createQName(((String)association.getValue()));
                  }
                  else
                  {
                	  assocTypeQname = QName.createQName(((String)association.getValue()), this.namespaceService);
                  }
            	
            }
            
            data.removeFieldData(ASSOCIATION);
