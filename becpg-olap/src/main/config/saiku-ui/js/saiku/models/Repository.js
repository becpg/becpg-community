...
var RepositoryObject = Backbone.Model.extend( {
    url: function( ) {
        var segment ="/alfrepository/resource";
...
var RepositoryAclObject = Backbone.Model.extend( {
    url: function( ) {
        var segment =  "/alfrepository/resource/acl";
        return encodeURI(Saiku.session.username + segment);
    },
...
var SavedQuery = Backbone.Model.extend({
    ...
    url: function() {
        var u =  encodeURI(Saiku.session.username + "/alfrepository/resource");
        return u;
    },
...
var Repository = Backbone.Collection.extend({
    ...
    url: function() {
        var segment =  "/alfrepository/?type=saiku";
        return encodeURI(Saiku.session.username + segment);
    }
});
