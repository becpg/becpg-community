...
wget --delete-after --http-user=admin --http-password=prolainat2013+ --header=Accept-Charset:iso-8859-1,utf-8 --header=Accept-Language:en-us --post-data reset=on http://localhost:8080/share/page/index
