  ...
  /**
   ...
   YAHOO.extend(Alfresco.component.TaskEditHeader, Alfresco.component.ShareFormManager,
   {
      ...
      onTaskDetailedData: function TEH_onTaskDetailedData(layer, args)
      {
         ...
         // refs #3973 - disable reassign for project tasks
         if(task.definition.type.name == "pjtwf:adhocTask" || task.definition.type.name == "npdwf:newProductTask"){
        	 task.isReassignable = false;
         }
