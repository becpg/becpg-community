...
(function()
{
  ...
  /**
   ...
   YAHOO.extend(Alfresco.component.TaskEditHeader, Alfresco.component.ShareFormManager,
   {
         ...
         if (!task.isEditable)
         {
            ...
            YAHOO.lang.later(2000, this, function()
            {
               ...
               if(this.referrerValue)
               {
                  ...
                  else if(this.referrerValue=='project-list')
                  {
                      document.location.href = $siteURL("project-list?view=tasks");
                   }
                }
                else
                {
          ...
          } else if(this.referrerValue && this.referrerValue == 'project-list') {
        	  this.options.defaultUrl = $siteURL("project-list?view=tasks");
          }
      ...
      {
    	  if(this.referrerValue && this.referrerValue=='project-list') {
              return document.location.href = $siteURL("project-list?view=tasks");
          }
