                                 ...
                                 <tr>
                                    <td>
                                       ...
                                       <div style="font-size: 14px; margin: 12px 0px 0px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                                ...
                                                <p style="padding-top:10px; margin:3px 0px 0px 0px">リマインダーとして</p><div class="line"></div>
                                                <p style="margin:0px">再起動されたタスク : <b>${args.task}</b>
                                                <br /><span>締め切り : <b>${args.dueDate?date}</b></span>.
                                                </p>
                                              
                                                <br /><a htref="${shareUrl}/page/task-edit?taskId=${args.taskId}"><button ><b>タスクを表示</b></button></a>
                                       </div>
                                    </td>
                                 </tr>
                              </table>
