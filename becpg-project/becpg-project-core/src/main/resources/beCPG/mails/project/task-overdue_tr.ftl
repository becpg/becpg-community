                                 ...
                                 <tr>
                                    <td>
                                       ...
                                       <div style="font-size: 14px; margin: 12px 0px 0px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                                ...
                                                <p style="padding-top:10px; margin:3px 0px 0px 0px">Geri çağırma</p><div class="line"></div>
                                                <p style="margin:0px">Görev yeniden başlatıldı : <b>${args.task}</b>
                                                <br /><span>Bitiş tarihi : <b>${args.dueDate?date}</b></span>.
                                                </p>
                                              
                                                <br /><a htref="${shareUrl}/page/task-edit?taskId=${args.taskId}"><button ><b>Görevi görüntüle</b></button></a>
                                       </div>
                                    </td>
                                 </tr>
                              </table>
