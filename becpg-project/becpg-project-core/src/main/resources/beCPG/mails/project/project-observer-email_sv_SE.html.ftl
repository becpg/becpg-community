                                        ...
                                        <#if (args.project.properties["bcpg:modifiedCatalog1"])??>
                                            ...
                                            <#assign cmModified = args.project.properties["cm:modified"]>
                                                ...
                                                <#else>
												 ...
												 <p>Uppgiften har ändrats från <b>${args.beforeState}</b> på 
										      			...
										      			<div class="delivrable-status delivrable-status-${deliverable.properties["pjt:dlState"]!"InProgress"}"></div>
										      				<div class="delivrable-container">
										      						<#if deliverable.properties["pjt:dlUrl"]?? && deliverable.properties["pjt:dlUrl"]!="">
										      							<span class="doc-url"><a title="Följ länken" href="${deliverable.properties["pjt:dlUrl"]}">
															   			...
															   			<#list deliverable.assocs["pjt:dlContent"] as content>
															                  <#if content.hasPermission("Read")>
																                  <#if content.isContainer>
																	                   <span class="doc-file"><a title="Öppna mappen" href="${shareUrl}/page/site/${content.getSiteShortName()!"valid"}/folder-details?nodeRef=${content.nodeRef}">
																                  ...
																                  <#else>
																                  	 <span class="doc-file"><a title="Öppna dokument" href="${shareUrl}/page/site/${content.getSiteShortName()!"valid"}/document-details?nodeRef=${content.nodeRef}">
