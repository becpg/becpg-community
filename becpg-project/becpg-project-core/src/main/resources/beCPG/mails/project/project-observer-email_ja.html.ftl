                                                    ...
                                                    <img class="img" src="${shareUrl}/res/components/images/project-email-logo.png" alt="" height="64" border="0"/>
                                                        ...
                                                        <td>
                                                            ...
                                                            <#if (args.project.properties["cm:modifier"])??>
                                                                ...
                                                                <#else> 
                                                                    <p class="Stitle" style="color: #ff642d; font-weight: bold; margin-top:1px;">が更新されました。</p>

                                                            </#if>
                                                            <a title="プロジェクトを開く" href="${shareUrl}/page/entity-data-lists?list=taskList&nodeRef=${args.project.nodeRef}"><button ><b>プロジェクトを開く</b></button></a>
                                                        </td>                                              
                                                </tr>
                                            </table>
                                                                ...
                                                                <div class="delivrable-status delivrable-status-${deliverable.properties["pjt:dlState"]!"InProgress"}"></div>
                                                                    <div class="delivrable-container">
                                                                        <#if deliverable.properties["pjt:dlUrl"]?? && deliverable.properties["pjt:dlUrl"]!="">
                                                                                    <span class="doc-url"><a title="リンクをたどる" href="${deliverable.properties["pjt:dlUrl"]}">
                                                                                    ...
                                                                                    <#list deliverable.assocs["pjt:dlContent"] as content>
                                                                                        <#if content.hasPermission("Read")>
                                                                                            <#if content.isContainer>
                                                                                                <span class="doc-file"><a title="フォルダを開きます" href="${shareUrl}/page/site/${content.getSiteShortName()!"valid"}/folder-details?nodeRef=${content.nodeRef}">
                                                                                            ...
                                                                                            <#else>
                                                                                                <span class="doc-file"><a title="ドキュメントを開く" href="${shareUrl}/page/site/${content.getSiteShortName()!"valid"}/document-details?nodeRef=${content.nodeRef}">
