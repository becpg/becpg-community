 ...
 * @author quere
 */
public class ProjectMultiLevelPlanningIT extends AbstractProjectTestCase {

	private static final Log logger = LogFactory.getLog(ProjectMultiLevelPlanningIT.class);
	...
	public void testCalculatePlanningDates() throws ParseException {
		...
		inWriteTx(() -> {
			...
			// alfrescoRepository.findOne(projectNodeRef);
