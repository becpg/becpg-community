...
public class BeCPGTestHelper {
	...
	public static NodeRef createUser(String userName) {
		if (!RepoBaseTestCase.INSTANCE.personService.personExists(userName)) {
			...
			ppOne.put(fr.becpg.model.BeCPGModel.PROP_EMAIL_TASK_OBSERVER_DISABLED, false);
			...
			RepoBaseTestCase.INSTANCE.nodeService.setProperty(personRef, fr.becpg.model.BeCPGModel.PROP_EMAIL_TASK_OBSERVER_DISABLED, false);
			return personRef;
		}
	}
