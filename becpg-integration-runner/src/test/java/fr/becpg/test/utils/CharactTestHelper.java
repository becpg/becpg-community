...
public class CharactTestHelper {
    ...
    public static NodeRef getOrCreateH(NodeService nodeService, String hCode) {
        ...
        return getOrCreateNode(
            nodeService,
            "/app:company_home/cm:System/cm:SecurityLists/bcpg:entityLists/cm:HazardStatements",
            hCode,
            GHSModel.TYPE_HAZARD_STATEMENT,
            properties
        );
    }
    ...
    public static NodeRef getOrCreatePicto(NodeService nodeService, String hCode) {
        ...
        return getOrCreateNode(
            nodeService,
            "/app:company_home/cm:System/cm:SecurityLists/bcpg:entityLists/cm:Pictograms",
            hCode,
            GHSModel.TYPE_PICTOGRAM,
            properties
        );
    }
    ...
    public static NodeRef getOrCreateIng(NodeService nodeService, String ingName) {
        ...
        return getOrCreateNode(
            nodeService,
            "/app:company_home/cm:System/cm:Characts/bcpg:entityLists/cm:Ings",
            ingName,
            PLMModel.TYPE_ING,
            properties
        );
    ...
    public static NodeRef getOrCreatePhysico(NodeService nodeService, String name) {
        ...
        return getOrCreateNode(
            nodeService,
            "/app:company_home/cm:System/cm:Characts/bcpg:entityLists/cm:PhysicoChems",
            name,
            PLMModel.TYPE_PHYSICO_CHEM,
            properties
        );
    }
}
