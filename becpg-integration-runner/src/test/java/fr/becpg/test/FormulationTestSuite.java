...
@RunWith(Suite.class)
@SuiteClasses(value={
	CharactDetailsFormulationIT.class,
	CompareFormulationIT.class,
	FormulationCalcILWithYieldOnCompIT.class,
	FormulationCheckPropsOfCompIT.class,
	FormulationFullIT.class,
	FormulationGenericRawMaterialIT.class,
	FormulationMultiLevelILIT.class,
	FormulationProductWithoutQtyIT.class,
	FormulationTareIT.class,
	FormulationIT.class,
	FormulationWithIngRequirementsTest.class,
	LabelingFormulationIT.class
})
