...
public class CompareDocumentServiceIT extends AbstractCompareProductTest {

	private static final Log logger = LogFactory.getLog(CompareDocumentServiceIT.class);
