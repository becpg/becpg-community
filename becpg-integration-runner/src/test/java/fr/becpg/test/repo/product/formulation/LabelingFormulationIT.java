...
public class LabelingFormulationIT extends AbstractFinishedProductTest {
	...
	public void testCalculateILL() throws Exception {
		...
		checkILL(finishedProductNodeRef1, labelingRuleList,
				"garniture french 50% (ing3 french 41,7%, ing4 french 8,3%), pâte french 50% (legal Raw material 12 22,5% (ing2 french 16,9%, ing1 french 5,6%), ing2 french 15%, ing1 french 7,5%, garniture french 2,5% (ing3 french 2,1%, ing4 french 0,4%), pâte french 2,5% (legal Raw material 12 1,7% (ing2 french 1,3%, ing1 french 0,4%), ing2 french 0,6%, ing1 french 0,3%))",
				Locale.FRENCH);
