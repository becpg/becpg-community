...
public class BeCPGQueryBuilderTest {
	...
	public void testQueryGeneration() {
		...
		queryBuilder = BeCPGQueryBuilder.createQuery().ofType(BeCPGModel.TYPE_ENTITY_V2).isNotNull(BeCPGModel.PROP_CODE)
				.excludeAspect(BeCPGModel.ASPECT_ENTITY_TPL).withAspect(BeCPGModel.ASPECT_COMPOSITE_VERSION).addSort(BeCPGModel.PROP_CODE, true);
		...
		// .andBetween(BeCPGModel.PROP_SORT, String.valueOf(startSort + 1),
		// "MAX")
		// .andBetween(BeCPGModel.PROP_DEPTH_LEVEL, "1",
		// Integer.toString(level))
		// .isNotNull(BeCPGModel.PROP_SORT).addSort(BeCPGModel.PROP_SORT,
		// true).singleValue();
