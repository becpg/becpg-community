 ...
 * @author querephi
 */
public class EntityListsWebScriptIT extends PLMBaseTestCase {

	private static final Log logger = LogFactory.getLog(EntityListsWebScriptIT.class);
	...
	public void testProductList() throws Exception {
		...
		// (RawMaterialData)productFactory.getProduct(rawMaterialNodeRef,
		// productDictionaryService.getDataLists());
		// assertEquals("Raw material must have 2 costs",
		// rawMaterial.getCostList().size()==2);
		// assertEquals("Raw material must have 1 nut",
		// rawMaterial.getNutList().size()==1);
		...
		// (FinishedProductData)productFactory.getProduct(finishedProductNodeRef,
		// productDictionaryService.getDataLists());
		// assertEquals("Finished product don't have costs",
		// finishedProduct.getCostList()==null);
		// assertEquals("Finished product don't have nuts",
		// finishedProduct.getNutList()==null);
