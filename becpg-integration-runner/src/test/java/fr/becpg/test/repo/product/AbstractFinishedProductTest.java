...
public abstract class AbstractFinishedProductTest extends PLMBaseTestCase {
	...
	protected void initParts() {
		...
		inWriteTx(() -> {
			...
			nutList.add(NutListDataItem.build().withValue(1d).withUnit("g/100g").withMini(0.8d).withMaxi(2.1d).withGroup("Groupe 1").withNut(nut1)
					.withIsManual(false));
			nutList.add(NutListDataItem.build().withValue(2d).withUnit("g/100g").withMini(1.5d).withMaxi(2.2d).withGroup("Groupe 1").withNut(nut2)
					.withIsManual(false));
			nutList.add(NutListDataItem.build().withValue(4d).withUnit("g/100g").withMini(0.8d).withMaxi(2.1d).withGroup("Groupe 1").withNut(nut3)
					.withIsManual(false));
			nutList.add(NutListDataItem.build().withValue(3d).withUnit("g/100g").withMini(0.8d).withMaxi(2.1d).withGroup("Groupe 1").withNut(nut4)
					.withIsManual(false));
			...
			IngListDataItem rawMaterial1Ing1 = IngListDataItem.build().withQtyPerc(100 / 3d).withGeoOrigin(geoOrigins).withBioOrigin(bioOrigins)

					.withIngredient(ing1)

					.withMini(25d).withMaxi(90d);
		...
		inWriteTx(() -> {
			...
			// nutList
			List<NutListDataItem> nutList = new ArrayList<>();
			nutList.add(NutListDataItem.build().withValue(1d).withUnit("g/100g").withMini(0.8d).withMaxi(1.1d).withGroup("Groupe 1").withNut(nut1)
					.withIsManual(false));
			nutList.add(NutListDataItem.build().withValue(2d).withUnit("g/100g").withMini(0.8d).withMaxi(2.1d).withGroup("Groupe 1").withNut(nut2)
					.withIsManual(false));
			nutList.add(NutListDataItem.build().withValue(6d).withUnit("g/100g").withMini(0.8d).withMaxi(2.1d).withGroup("Groupe 1").withNut(nut3)
					.withIsManual(false));
			...
			IngListDataItem rawMaterial2Ing1 = IngListDataItem.build().withQtyPerc(100 / 4d).withGeoOrigin(geoOrigins).withBioOrigin(bioOrigins)
					.withIsGMO(true).withIsIonized(true).withIngredient(ing1).withMini(15d).withMaxi(75d);
			...
			IngListDataItem rawMaterial2Ing2 = IngListDataItem.build().withQtyPerc(300 / 4d).withGeoOrigin(geoOrigins).withBioOrigin(bioOrigins)
					.withIsGMO(false).withIsIonized(false).withIsProcessingAid(false).withIngredient(ing2).withIsManual(false).withMini(25d)
					.withMaxi(86d);
		...
		inWriteTx(() -> {
			...
			// nutList
			List<NutListDataItem> nutList = new ArrayList<>();
			nutList.add(NutListDataItem.build().withValue(1d).withUnit("g/100g").withMini(null).withMaxi(null).withGroup("Groupe 1").withNut(nut1)
					.withIsManual(false));
			nutList.add(NutListDataItem.build().withValue(2d).withUnit("g/100g").withMini(null).withMaxi(null).withGroup("Groupe 1").withNut(nut2)
					.withIsManual(false));
			nutList.add(NutListDataItem.build().withValue(4d).withUnit("g/100g").withMini(0.8d).withMaxi(2.1d).withGroup("Groupe 1").withNut(nut3)
					.withIsManual(false));
			...
			List<NodeRef> geoOrigins = new ArrayList<>();
			geoOrigins.add(geoOrigin2);
			ingList.add(IngListDataItem.build().withQtyPerc(100d).withGeoOrigin(geoOrigins).withBioOrigin(bioOrigins).withIsGMO(true)
					.withIsIonized(true).withIngredient(ing3));
			// physicoChem
			List<PhysicoChemListDataItem> physicoChemList = new ArrayList<>();
		...
		inWriteTx(() -> {
			...
			rawMaterial4.setCostList(new LinkedList<>());
			rawMaterial4.setNutList(new LinkedList<>());
			List<NutListDataItem> nutList = new ArrayList<>();
			nutList.add(NutListDataItem.build().withValue(0d).withUnit("g/100g").withMini(0d).withMaxi(0d).withGroup("Groupe 1").withNut(nut1));
			nutList.add(NutListDataItem.build().withValue(0d).withUnit("g/100g").withMini(0d).withMaxi(0d).withGroup("Groupe 1").withNut(nut2));
		...
		inWriteTx(() -> {
			...
			// nutList
			List<NutListDataItem> nutList = new ArrayList<>();
			nutList.add(NutListDataItem.build().withValue(1d).withUnit("g/100g").withMini(0d).withMaxi(0d).withGroup("Groupe 1").withNut(nut1)
					.withIsManual(false));
			nutList.add(NutListDataItem.build().withValue(3d).withUnit("g/100g").withMini(0d).withMaxi(0d).withGroup("Groupe 1").withNut(nut2)
					.withIsManual(false));
		...
		inWriteTx(() -> {
			...
			// nutList
			List<NutListDataItem> nutList = new ArrayList<>();
			nutList.add(NutListDataItem.build().withValue(1d).withUnit("g/100mL").withMini(0.8d).withMaxi(1.1d).withGroup("Groupe 1").withNut(nut1)
					.withIsManual(false));
			nutList.add(NutListDataItem.build().withValue(2d).withUnit("g/100mL").withMini(0.8d).withMaxi(2.1d).withGroup("Groupe 1").withNut(nut2)
					.withIsManual(false));
			...
			List<NodeRef> geoOrigins = new ArrayList<>();
			geoOrigins.add(geoOrigin1);
			ingList.add(IngListDataItem.build().withQtyPerc(80d).withGeoOrigin(geoOrigins).withBioOrigin(bioOrigins).withIsGMO(true)
					.withIsIonized(true).withIngredient(ing1).withIsManual(false));
			bioOrigins = new ArrayList<>();
			bioOrigins.add(bioOrigin2);
			geoOrigins = new ArrayList<>();
			geoOrigins.add(geoOrigin2);
		...
		inWriteTx(() -> {
			...
			List<IngListDataItem> ingList = new ArrayList<>();
			ingList.add(IngListDataItem.build().withQtyPerc(100d).withGeoOrigin(null).withBioOrigin(null).withIsGMO(false).withIsIonized(false)
					.withIsProcessingAid(false).withIngredient(ing5).withIsManual(false));

			ingList.add(IngListDataItem.build().withQtyPerc(70d).withGeoOrigin(null).withBioOrigin(null).withIsGMO(false).withIsIonized(false)
					.withIsProcessingAid(true).withParent(ingList.get(0)).withIngredient(ing1).withIsManual(false));
			ingList.add(IngListDataItem.build().withParent(ingList.get(0)).withQtyPerc(30d).withGeoOrigin(null).withBioOrigin(null).withIsGMO(false)
					.withIsIonized(false).withIsProcessingAid(false).withIngredient(ing4).withIsManual(false));
		...
		inWriteTx(() -> {
			...
			List<IngListDataItem> ingList = new ArrayList<>();
			ingList.add(IngListDataItem.build().withQtyPerc(100d).withGeoOrigin(null).withBioOrigin(null).withIsGMO(false).withIsIonized(false)
					.withIngredient(ingWater).withIsManual(false));
		...
		inWriteTx(() -> {
			...
			List<NodeRef> geoOrigins = new ArrayList<>();
			geoOrigins.add(geoOrigin1);
			ingList.add(IngListDataItem.build().withQtyPerc(100 / 3d).withGeoOrigin(geoOrigins).withBioOrigin(bioOrigins).withIsGMO(false)
					.withIsIonized(false).withIsProcessingAid(false).withIngredient(ing1).withIsManual(false));
			geoOrigins = new ArrayList<>();
			geoOrigins.add(geoOrigin1);
			geoOrigins.add(geoOrigin2);
			ingList.add(IngListDataItem.build().withQtyPerc(200 / 3d).withGeoOrigin(geoOrigins).withBioOrigin(bioOrigins).withIsGMO(false)
		...
		inWriteTx(() -> {
			...
			List<NodeRef> geoOrigins = new ArrayList<>();
			geoOrigins.add(geoOrigin1);
			ingList.add(IngListDataItem.build().withQtyPerc(100 / 4d).withGeoOrigin(geoOrigins).withBioOrigin(bioOrigins).withIsGMO(true)
					.withIsIonized(true).withIsProcessingAid(false).withIngredient(ing1).withIsManual(false));
			bioOrigins = new ArrayList<>();
			bioOrigins.add(bioOrigin2);
			geoOrigins = new ArrayList<>();
			geoOrigins.add(geoOrigin2);
		...
		inWriteTx(() -> {
			...
			List<NodeRef> geoOrigins = new ArrayList<>();
			geoOrigins.add(geoOrigin2);
			ingList.add(IngListDataItem.build().withQtyPerc(200 / 3d).withGeoOrigin(geoOrigins).withBioOrigin(bioOrigins).withIsGMO(true)
					.withIsIonized(true).withIsProcessingAid(false).withIngredient(ing3).withIsManual(false));
			ingList.add(IngListDataItem.build().withQtyPerc(100 / 3d).withGeoOrigin(geoOrigins).withBioOrigin(bioOrigins).withIsGMO(true)
					.withIsIonized(true).withIsProcessingAid(false).withIngredient(ing4).withIsManual(false));
