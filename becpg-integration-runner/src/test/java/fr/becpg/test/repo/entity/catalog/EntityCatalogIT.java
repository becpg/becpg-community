...
public class EntityCatalogIT extends PLMBaseTestCase {
	...
	public void testMissingFields() {
		...
		final NodeRef sfNodeRef = inWriteTx(() -> {
			...
			allergenList.add(AllergenListDataItem.build().withQtyPerc(null).withVoluntary(true).withInVoluntary(true).withAllergen(allergens.get(0)).withIsManual(false));
			allergenList.add(AllergenListDataItem.build().withQtyPerc(null).withVoluntary(false).withInVoluntary(true).withAllergen(allergens.get(1)).withIsManual(false));
			allergenList.add(AllergenListDataItem.build().withQtyPerc(null).withVoluntary(true).withInVoluntary(false).withAllergen(allergens.get(2)).withIsManual(false));
			allergenList.add(AllergenListDataItem.build().withQtyPerc(null).withVoluntary(false).withInVoluntary(false).withAllergen(allergens.get(3)).withIsManual(false));
