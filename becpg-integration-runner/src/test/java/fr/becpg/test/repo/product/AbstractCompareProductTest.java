...
public abstract class AbstractCompareProductTest extends PLMBaseTestCase {
	...
	protected boolean checkStructCompareRow(List<StructCompareResultDataItem> structCompareResult, String productList, int depthLevel,
		...
		logger.debug("PARAMS : StrucCompareResult ,  productList="+productList + ", depthLevel="+depthLevel+ ", operator=" + operator + ", product1= " + product1+ ", product2="+ product2 +" , properties1=" + properties1 + "properties2="+properties2);
		for (StructCompareResultDataItem c : structCompareResult) {
			...
			logger.trace("File Name : " + tempProductList + " , depthLevel : " + c.getDepthLevel() + " , Operator " + c.getOperator()+ " tempProduct1 : " 
					+ tempProduct1 + " tempProduct2 : " + tempProduct2 + " , properties1 : " + c.getProperties1().toString()+ " , properties2 : " + c.getProperties2().toString());
