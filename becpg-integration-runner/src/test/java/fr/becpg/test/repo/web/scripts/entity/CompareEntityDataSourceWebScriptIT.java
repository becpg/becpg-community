...
public class CompareEntityDataSourceWebScriptIT extends AbstractCompareProductTest {
	...
	public void testGetProductsXmlDatasource() throws IOException {
		...
		String url = String.format("/becpg/entity/compare/datasource?entity=%s&entities=%s", fp1NodeRef.toString(), fp2NodeRef.toString());
	...
	public void testGetRawMaterialsXmlDatasource() throws IOException {
		String url = String.format("/becpg/entity/compare/datasource?entity=%s&entities=%s", rawMaterial1NodeRef.toString(),
			rawMaterial2NodeRef.toString() + "," + rawMaterial3NodeRef.toString() + "," + rawMaterial4NodeRef.toString());
