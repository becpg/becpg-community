...
public class NutriScoreIT extends PLMBaseTestCase {
	...
	@Value("${beCPG.formulation.score.nutriscore.regulatoryClass}")
	...
	public void testNutriScore() {
		...
		try {
			...
			NutrientRegulatoryHelper.setRegulatoryClassName("fr.becpg.repo.product.helper.Nutrient5C2021Helper");
			...
			NutrientRegulatoryHelper.setRegulatoryClassName(regulatoryClassName);
		}
	}
