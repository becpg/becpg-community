...
public class UserImportServiceIT extends PLMBaseTestCase {
	...
	private NodeRef createCSV() throws IOException {
		...
		ChildAssociationRef assocRef = nodeService.createNode(destNodeRef, ContentModel.ASSOC_CONTAINS,
				QName.createQName(NamespaceService.CONTENT_MODEL_1_0_URI, qname), ContentModel.TYPE_CONTENT);
