...
/**
 * {@code TestExecutionListener} which provides support for dependency injection
 ...
 * @since 2.5
 */
public class BeCPSpringTestListener extends AbstractTestExecutionListener {

	/**
	 * Attribute name for a {@link TestContext} attribute which indicates
	 * whether or not the dependencies of a test instance should be
	 * <em>reinjected</em> in {@link #beforeTestMethod(TestContext)
	 ...
	 * TestExecutionListeners}) may therefore choose to set this attribute to
	 * signal that dependencies should be reinjected <em>between</em> execution
	 * of individual test methods.
	 * <p>
	 * Permissible values include {@link Boolean#TRUE} and
	 * {@link Boolean#FALSE}.
	 */
	public static final String REINJECT_DEPENDENCIES_ATTRIBUTE = Conventions.getQualifiedAttributeName(DependencyInjectionTestExecutionListener.class,
	...
	/**
	 * Performs dependency injection on the {@link TestContext#getTestInstance()
	 * test instance} of the supplied {@link TestContext test context} by
	 * {@link AutowireCapableBeanFactory#autowireBeanProperties(Object, int, boolean)
	 * autowiring} and
	 * {@link AutowireCapableBeanFactory#initializeBean(Object, String)
	 * initializing} the test instance via its own
	 ...
	 * 
	 * @param testContext
	 *            the test context for which dependency injection should be
	 *            performed (never {@code null})
	 * @throws Exception
