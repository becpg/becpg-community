...
public abstract class AbstractListValuePluginTest extends RepoBaseTestCase {
	...
	public void initProducts() {
		...
		CompoListDataItem item = new CompoListDataItem(null, (CompoListDataItem) null, 1d, 0d, 0d, CompoListUnit.kg, 0d, null, DeclarationType.Detail, localSF1NodeRef);

		compoList.add(item);
		compoList.add(new CompoListDataItem(null, item, 1d, 0d, 0d, CompoListUnit.kg, 0d, null, DeclarationType.Declare, rawMaterial1NodeRef));
		compoList.add(new CompoListDataItem(null, item, 2d, 0d, 0d, CompoListUnit.kg, 0d, null, DeclarationType.Detail, rawMaterial2NodeRef));
		item = new CompoListDataItem(null, (CompoListDataItem) null, 1d, 0d, 0d, CompoListUnit.kg, 0d, null, DeclarationType.Detail, localSF2NodeRef);

		compoList.add(item);
		compoList.add(new CompoListDataItem(null, item, 3d, 0d, 0d, CompoListUnit.kg, 0d, null, DeclarationType.Declare, rawMaterial3NodeRef));
