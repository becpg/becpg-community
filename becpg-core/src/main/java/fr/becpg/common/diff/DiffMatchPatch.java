...
public class DiffMatchPatch {
     ...
     * Operations are tab-separated.  Inserted dmp is escaped using %xx notation.
     *
    ...
    public LinkedList<Diff> diffFromDelta(String text1, String delta)
                ...
                case '=':
                    ...
                    try {
                        ...
                        throw new IllegalArgumentException("Delta length (" + pointer
                                                                   + ") larger than source dmp length (" + text1.length()
                                                                   + ").", e);
                    }
                    if (token.charAt(0) == '=') {
        ...
        if (pointer != text1.length()) {
            throw new IllegalArgumentException("Delta length (" + pointer
                                                       + ") smaller than source dmp length (" + text1.length() + ").");
        }
        return diffs;
    }
    ...
    protected void patch_addContext(Patch patch, String text) {
        ...
        // Look for the first and last matches of pattern in dmp.  If two different
                ...
                case EQUAL:
                    ...
                    if (aDiff.text.length() >= 2 * Patch_Margin) {
                        ...
                        if (!patch.diffs.isEmpty()) {
                            ...
                            // Update prepatch dmp & pos to reflect the application of the
    ...
    /**
     * Merge a set of patches onto the dmp.  Return a patched dmp, as well
     * as an array of true/false values indicating which patches were applied.
     *
     * @param patches Array of Patch objects
     * @param text    Old dmp.
     * @return Two element Object array, containing the new dmp and an array of
     * boolean values.
     */
    public Object[] patch_apply(LinkedList<Patch> patches, String text) {
        ...
        for (Patch aPatch : patches) {
            ...
            if (start_loc == -1) {
                ...
                if (text1.equals(text2)) {
                    // Perfect match, just shove the replacement dmp in.
