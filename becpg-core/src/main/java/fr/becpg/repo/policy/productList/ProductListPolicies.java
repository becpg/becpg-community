 ...
 * @author querephi
 */
public class ProductListPolicies implements NodeServicePolicies.OnUpdatePropertiesPolicy {
	
	/** The logger. */
	private static Log logger = LogFactory.getLog(ProductListPolicies.class);
	...
	/**
	 * Initialize the name of the datalist with the local name if it is a productDataList.
	 *
