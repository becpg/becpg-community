...
public class AutoNumServiceImpl implements AutoNumService {
	 ...
	 */
	@Override
	public void createOrUpdateAutoNumValue(String className, String propertyName,
			long autoNumValue) {
	 ...
	 * @return the node ref
	 */
	private NodeRef createAutoNum(String className, String propertyName, long autoNumValue) {
    	...
    	String name = String.format(NAME, className, propertyName);
	 ...
	 */
	private NodeRef getAutoNumNodeRef(String className, String propertyName) {
