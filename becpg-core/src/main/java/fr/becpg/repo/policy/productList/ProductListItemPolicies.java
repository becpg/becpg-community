 ...
 * 
 */
package fr.becpg.repo.policy.productList;
 ...
 * @author querephi
 */
public class ProductListItemPolicies implements NodeServicePolicies.OnDeleteNodePolicy {
	
	/** The logger. */
	private static Log logger = LogFactory.getLog(ProductListItemPolicies.class);
	 ...
	 */
	public void init(){
		logger.debug("Init ProductListItemPolicies...");
		policyComponent.bindClassBehaviour(NodeServicePolicies.OnDeleteNodePolicy.QNAME, BeCPGModel.TYPE_PRODUCTLIST_ITEM, new JavaBehaviour(this, "onDeleteNode"));
	}
	
	/**
	 * Store in the product list folder that an item has been deleted.
	 *
