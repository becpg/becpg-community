...
/**
 * The Class CheckOutWebScript.
 *
 * @author querephi
 */
public class CheckOutWebScript extends DeclarativeWebScript  {
	...
	/** The logger. */
	private static Log logger = LogFactory.getLog(CheckOutWebScript.class);	
	...
	protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache){
		...
		logger.debug("CheckOutWebScript executeImpl()");			
		NodeRef productNodeRef = new NodeRef(storeType, storeId, nodeId);						
		NodeRef checkOutRef = productCheckOutCheckInService.checkout(productNodeRef);
		logger.debug("Check out node: " + checkOutRef);
		
		Map<String, Object> model = new HashMap<String, Object>();
		model.put(MODEL_KEY_NAME_NODEREF, checkOutRef);
