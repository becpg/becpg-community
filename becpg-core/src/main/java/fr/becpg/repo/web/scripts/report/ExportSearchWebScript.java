...
public class ExportSearchWebScript extends AbstractSearchWebScript {
	 ...
	 * 
	 * @param exportSearchService
	 *            the new export search service
	 */
	...
	public void execute(WebScriptRequest req, WebScriptResponse res) throws IOException {
		...
		try {
			...
			// TODO Try-in-resource java 7
			CountingOutputStream c = null;
			try {
				c = new CountingOutputStream(res.getOutputStream());
