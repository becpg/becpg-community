...
public class EntityVersionServiceImpl2 implements EntityVersionService {
	...
	private static final Log logger = LogFactory.getLog(EntityVersionServiceImpl2.class);
	...
	private NodeRef internalMergeBranch(NodeRef branchNodeRef, NodeRef branchToNodeRef, VersionType versionType, String description, boolean impactWused,
	...
	@Override
	public NodeRef extractVersion(final NodeRef versionNodeRef) {
