...
public class VersionData {
	...
	/**
	 * The start date of version effectivity
	 */
	private Date startEffectivity;

	/**
	 * The end date of version effectivity
	 */
	 ...
	 *            the creator last name
	 */
	public VersionData(NodeRef nodeRef, String name, String label, String description, Date createdDate,
			String creatorUserName, String creatorFirstName, String creatorLastName, Date startEffectivity,
			Date endEffectivity) {
		...
		this.setStartEffectivity(startEffectivity);
		this.setEndEffectivity(endEffectivity);
	}
