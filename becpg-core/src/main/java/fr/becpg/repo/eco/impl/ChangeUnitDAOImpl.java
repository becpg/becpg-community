...
public class ChangeUnitDAOImpl implements BeCPGDao<ChangeUnitData> {
	...
	@Override
	public NodeRef create(NodeRef parentNodeRef, ChangeUnitData changeUnitData) {
	...
	@Override
	public ChangeUnitData find(NodeRef changeUnitNodeRef) {
		...
		ChangeUnitData changeUnitData = new ChangeUnitData(changeUnitNodeRef, 
									revision, 
