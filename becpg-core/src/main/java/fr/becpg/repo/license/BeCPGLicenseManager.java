...
public class BeCPGLicenseManager {
	...
	public static final String LICENSE_READ_NAMED = "LICENSE_READ_NAMED";
	public static final String LICENSE_WRITE_NAMED = "LICENSE_WRITE_NAMED";
	public static final String LICENSE_READ_CONCURRENT = "LICENSE_READ_CONCURRENT";
	public static final String LICENSE_WRITE_CONCURRENT = "LICENSE_WRITE_CONCURRENT";
	public static final String LICENSE_SUPPLIER_CONCURRENT = "LICENSE_SUPPLIER_CONCURRENT";

	private static final String CACHE_KEY = "LICENSE_KEY";
	...
	public void readLicense() {
		try {
			...
			if(licenseObj != null) {
				allowedNamedRead = licenseObj.has(LICENSE_READ_NAMED) ? licenseObj.getLong(LICENSE_READ_NAMED) : -1L;
				allowedNamedWrite = licenseObj.has(LICENSE_WRITE_NAMED) ? licenseObj.getLong(LICENSE_WRITE_NAMED) : -1L;
				allowedConcurrentRead = licenseObj.has(LICENSE_READ_CONCURRENT) ? licenseObj.getLong(LICENSE_READ_CONCURRENT) : -1L;
				allowedConcurrentWrite = licenseObj.has(LICENSE_WRITE_CONCURRENT) ? licenseObj.getLong(LICENSE_WRITE_CONCURRENT) : -1L;
				allowedConcurrentSupplier = licenseObj.has(LICENSE_SUPPLIER_CONCURRENT) ? licenseObj.getLong(LICENSE_SUPPLIER_CONCURRENT) : -1L;
			}
