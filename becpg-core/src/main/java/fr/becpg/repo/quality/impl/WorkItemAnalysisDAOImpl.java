    		...
    		if(controlDefListNodeRef != null)
    		{
		    	...
		    	{	    			
		    		...
		    		ControlListDataItem controlDefListDataItem = new ControlListDataItem(nodeRef, 
		    							...
		    							(Double)nodeService.getProperty(nodeRef, QualityModel.PROP_CL_MINI),
		    							(Double)nodeService.getProperty(nodeRef, QualityModel.PROP_CL_MAXI),
		    							...
		    							(Double)nodeService.getProperty(nodeRef, QualityModel.PROP_CL_VALUE),
		    							(Double)nodeService.getProperty(nodeRef, QualityModel.PROP_CL_TARGET),
