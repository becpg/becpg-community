...
public class StructCompareResultDataItem {
	 ...
	 * @param properties2 the properties2
	 */
	public StructCompareResultDataItem(QName productList, int depthLevel, StructCompareOperator operator, NodeRef characteristic1, NodeRef characteristic2, Map<QName, String> properties1, Map<QName, String> properties2){
