...
public interface BeCPGModel {
	...
	// product
		...
		@Deprecated
		QName ASSOC_INGLIST_SUBING = QName.createQName(BeCPGModel.BECPG_URI, "ingListSubIng");	
		...
		QName TYPE_LABELCLAIMLIST = QName.createQName(BeCPGModel.BECPG_URI,
				"labelClaimList");
		QName PROP_LCL_TYPE = QName.createQName(BeCPGModel.BECPG_URI,
				"lclType");
		...
		@Deprecated
		QName PROP_ING_TYPE = QName.createQName(BeCPGModel.BECPG_URI, "ingType");
		...
		@Deprecated
		QName ASSOC_PRODUCT_SPECIFICATION = QName.createQName(BeCPGModel.BECPG_URI, "productSpecification");
