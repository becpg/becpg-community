                           ...
                           <td style="padding: 10px 30px 0px;">
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <p>ボンジュール</p>
                                             ...
                                             <p>
                                             	<#if args.mailBody??>
                                             		${args.mailBody} で終わりました。 
                                             	</#if>
                                             	<b>
                                             		<#if args.actionState> 成功<#else> エラー</#if>
                                             	</b> 後 <#if args.runTime < 60 ><b>${args.runTime?round}</b> 秒
                                             				<#else><b>${(args.runTime/60)?round}</b> 分</#if>
                                             </p>
                                             ...
                                             <#if args.url??>
	                                           	 <table cellpadding="2" cellspacing="0" border="0">
	                                                 ...
	                                                 <tr>
	                                                 	<a href="${shareUrl}/${args.url}"><button><b>ビュー</b></button></a>
	                                                 </tr>                                                                
												 </table>
											 </#if>
