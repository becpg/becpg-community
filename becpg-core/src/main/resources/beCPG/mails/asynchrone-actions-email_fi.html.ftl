                           ...
                           <td style="padding: 10px 30px 0px;">
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <p>Hei,</p>
                                             ...
                                             <p>
                                             	<#if args.mailBody??>
                                             		${args.mailBody} päättyi :
                                             	</#if>
                                             	<b>
                                             		<#if args.actionState> Menestys<#else> Vika</#if>
                                             	</b>, jälkeen <#if args.runTime < 60 ><b>${args.runTime?round}</b> sekuntia.
                                             				<#else><b>${(args.runTime/60)?round}</b> pöytäkirja.</#if>
                                             </p>
                                             ...
                                             <#if args.url??>
	                                           	 <table cellpadding="2" cellspacing="0" border="0">
	                                                 ...
	                                                 <tr>
	                                                 	<a href="${shareUrl}/${args.url}"><button><b>Näyttö</b></button></a>
	                                                 </tr>                                                                
												 </table>
											 </#if>
                              </table>
