                                            ...
                                            <#if args.entities?size != 0>
                                             <table cellpadding="0" cellspacing="0" style="border:solid 1px black;padding: 0px;" >
                                               <tr style="background-color: #004254;color:white">
                                                 <th>ファイル</th>
                                                 <th class="becpg_cellBorderLeft">オブジェクト</th>
                                                 <#if args.versions??>
                                                 <th class="becpg_cellBorderLeft">作成日</th>
                                                 <th class="becpg_cellBorderLeft">バージョン</th>
                                                 <th class="becpg_cellBorderLeft">創造主</th>
                                                 <th class="becpg_cellBorderLeft">コメント</th>
                                                 <#else>
                                             ...
                                             <#if exportNodeRef??>
	                                             <p>
	                                                 <a href="${shareUrl}/proxy/alfresco/slingshot/node/content/${exportNodeRef?replace('://','/')}/">レポートをダウンロード</a>
	                                             </p>
                                             </#if>
                                             <#else>
