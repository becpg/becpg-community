                                            ...
                                            <#if args.entities?size != 0>
                                             <table cellpadding="0" cellspacing="0" style="border:solid 1px black;padding: 0px;" >
                                               <tr style="background-color: #004254;color:white">
                                                 <th>Klasör</th>
                                                 <th class="becpg_cellBorderLeft">Nesne</th>
                                                 <#if args.versions??>
                                                 <th class="becpg_cellBorderLeft">Oluşturulma tarihi</th>
                                                 <th class="becpg_cellBorderLeft">Versiyon</th>
                                                 <th class="becpg_cellBorderLeft">Yaratıcı</th>
                                                 <th class="becpg_cellBorderLeft">Yorum Yap</th>
                                                 <#else>
