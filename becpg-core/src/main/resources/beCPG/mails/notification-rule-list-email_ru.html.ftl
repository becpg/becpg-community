                                            ...
                                            <#if args.entities?size != 0>
                                             <table cellpadding="0" cellspacing="0" style="border:solid 1px black;padding: 0px;" >
                                               <tr style="background-color: #004254;color:white">
                                                 <th>Папка</th>
                                                 <th class="becpg_cellBorderLeft">Объект</th>
                                                 <#if args.versions??>
                                                 <th class="becpg_cellBorderLeft">Дата создания</th>
                                                 <th class="becpg_cellBorderLeft">Версия</th>
                                                 <th class="becpg_cellBorderLeft">Создатель</th>
                                                 <th class="becpg_cellBorderLeft">Комментарий</th>
                                                 <#else>
                                             ...
                                             <#if exportNodeRef??>
	                                             <p>
	                                                 <a href="${shareUrl}/proxy/alfresco/slingshot/node/content/${exportNodeRef?replace('://','/')}/">Скачать отчет</a>
	                                             </p>
                                             </#if>
                                             <#else>
