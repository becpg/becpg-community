                                            ...
                                            <#if args.entities?size != 0>
                                             <table cellpadding="0" cellspacing="0" style="border:solid 1px black;padding: 0px;" >
                                               <tr style="background-color: #004254;color:white">
                                                 <th>Cartella</th>
                                                 <th class="becpg_cellBorderLeft">Oggetto</th>
                                                 <#if args.versions??>
                                                 <th class="becpg_cellBorderLeft">Data di creazione</th>
                                                 <th class="becpg_cellBorderLeft">Versione</th>
                                                 <th class="becpg_cellBorderLeft">Creatore</th>
                                                 <th class="becpg_cellBorderLeft">Commento</th>
                                                 <#else>
                                             ...
                                             <#if exportNodeRef??>
	                                             <p>
	                                                 <a href="${shareUrl}/proxy/alfresco/slingshot/node/content/${exportNodeRef?replace('://','/')}/">Scarica il rapporto</a>
	                                             </p>
                                             </#if>
                                             <#else>
