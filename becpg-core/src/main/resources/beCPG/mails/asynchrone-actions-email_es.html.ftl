                           ...
                           <td style="padding: 10px 30px 0px;">
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <p>Buenos dias,</p>
                                             ...
                                             <p>
                                             	<#if args.mailBody??>
                                             		${args.mailBody} terminó con :
                                             	</#if>
                                             	<b>
                                             		<#if args.actionState> éxito<#else> culpa</#if>
                                             	</b>, después <#if args.runTime < 60 ><b>${args.runTime?round}</b> segundos.
                                             				<#else><b>${(args.runTime/60)?round}</b> minutos.</#if>
                                             </p>
                                             ...
                                             <#if args.url??>
	                                           	 <table cellpadding="2" cellspacing="0" border="0">
	                                                 ...
	                                                 <tr>
	                                                    <td>Haga clic en el enlace para acceder al resultado:</td>
	                                                 </tr>
	                                                 <tr>
