                                            ...
                                            <#if args.entities?size != 0>
                                             <table cellpadding="0" cellspacing="0" style="border:solid 1px black;padding: 0px;" >
                                               <tr style="background-color: #004254;color:white">
                                                 <th>Kansio</th>
                                                 <th class="becpg_cellBorderLeft">Esine</th>
                                                 <#if args.versions??>
                                                 <th class="becpg_cellBorderLeft">Luomispäivä</th>
                                                 <th class="becpg_cellBorderLeft">Versio</th>
                                                 <th class="becpg_cellBorderLeft">Luoja</th>
                                                 <th class="becpg_cellBorderLeft">Kommentti</th>
                                                 <#else>
                                             ...
                                             <#if exportNodeRef??>
	                                             <p>
	                                                 <a href="${shareUrl}/proxy/alfresco/slingshot/node/content/${exportNodeRef?replace('://','/')}/">Lataa raportti</a>
	                                             </p>
                                             </#if>
                                             <#else>
