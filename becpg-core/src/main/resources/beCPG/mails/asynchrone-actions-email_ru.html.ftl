                           ...
                           <td style="padding: 10px 30px 0px;">
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <p>Привет,</p>
                                             ...
                                             <p>
                                             	<#if args.mailBody??>
                                             		${args.mailBody} закончился :
                                             	</#if>
                                             	<b>
                                             		<#if args.actionState> успех<#else> вина</#if>
                                             	</b>, после <#if args.runTime < 60 ><b>${args.runTime?round}</b> секунды.
                                             				<#else><b>${(args.runTime/60)?round}</b> минут.</#if>
                                             </p>
                                             ...
                                             <#if args.url??>
	                                           	 <table cellpadding="2" cellspacing="0" border="0">
	                                                 ...
	                                                 <tr>
	                                                 	<a href="${shareUrl}/${args.url}"><button><b>Отображать</b></button></a>
	                                                 </tr>                                                                
												 </table>
											 </#if>
