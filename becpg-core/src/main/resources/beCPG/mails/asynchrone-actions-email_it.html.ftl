                           ...
                           <td style="padding: 10px 30px 0px;">
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <p>Buongiorno,</p>
                                             ...
                                             <p>
                                             	<#if args.mailBody??>
                                             		${args.mailBody} finito con :
                                             	</#if>
                                             	<b>
                                             		<#if args.actionState> successo<#else> colpa</#if>
                                             	</b>, dopo <#if args.runTime < 60 ><b>${args.runTime?round}</b> secondi.
                                             				<#else><b>${(args.runTime/60)?round}</b> minuti.</#if>
                                             </p>
                                             ...
                                             <#if args.url??>
	                                           	 <table cellpadding="2" cellspacing="0" border="0">
	                                                 ...
	                                                 <tr>
	                                                    <td>Fare clic sul collegamento per accedere al risultato:</td>
	                                                 </tr>
	                                                 <tr>
