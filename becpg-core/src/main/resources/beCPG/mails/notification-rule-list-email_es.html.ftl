                                            ...
                                            <#if args.entities?size != 0>
                                             <table cellpadding="0" cellspacing="0" style="border:solid 1px black;padding: 0px;" >
                                               <tr style="background-color: #004254;color:white">
                                                 <th>Carpetas</th>
                                                 <th class="becpg_cellBorderLeft">Objeto</th>
                                                 <#if args.versions??>
                                                 <th class="becpg_cellBorderLeft">Fecha de creación</th>
                                                 <th class="becpg_cellBorderLeft">Versión</th>
                                                 <th class="becpg_cellBorderLeft">Creador</th>
                                                 <th class="becpg_cellBorderLeft">Comentario</th>
                                                 <#else>
                                             ...
                                             <#if exportNodeRef??>
	                                             <p>
	                                                 <a href="${shareUrl}/proxy/alfresco/slingshot/node/content/${exportNodeRef?replace('://','/')}/">Descargar el informe</a>
	                                             </p>
                                             </#if>
                                             <#else>
