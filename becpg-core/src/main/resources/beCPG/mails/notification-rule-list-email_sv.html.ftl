                                            ...
                                            <#if args.entities?size != 0>
                                             <table cellpadding="0" cellspacing="0" style="border:solid 1px black;padding: 0px;" >
                                               <tr style="background-color: #004254;color:white">
                                                 <th>Mapp</th>
                                                 <th class="becpg_cellBorderLeft">Objekt</th>
                                                 <#if args.versions??>
                                                 <th class="becpg_cellBorderLeft">Skapelsedagen</th>
                                                 <th class="becpg_cellBorderLeft">Version</th>
                                                 <th class="becpg_cellBorderLeft">Skapare</th>
                                                 <th class="becpg_cellBorderLeft">Kommentar</th>
                                                 <#else>
                                             ...
                                             <#if exportNodeRef??>
	                                             <p>
	                                                 <a href="${shareUrl}/proxy/alfresco/slingshot/node/content/${exportNodeRef?replace('://','/')}/">Ladda ner rapporten</a>
	                                             </p>
                                             </#if>
                                             <#else>
