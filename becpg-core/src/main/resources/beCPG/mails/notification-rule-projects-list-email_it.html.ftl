                              ...
                              <table cellpadding="0" cellspacing="0" border="0">
                                       ...
                                       <#assign dateField=notification.properties["bcpg:nrDateField"]>
                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             ...
                                             <p>
                                             	Trova gli oggetti interessati di seguito: 
                                              </p>
                                            <#if args.entities?size != 0>
                                             <table cellpadding="0" cellspacing="0" style="border:solid 1px black;padding: 0px;" >
                                               <tr style="background-color: #004254;color:white">
                                                 <#--  <th>Folder</th>  -->
                                                 <th>Nome</th>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Dipartimento</th>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Priorità</th>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Stato del progetto</th>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Responsabile del Progetto</th>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Descrizione</th>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Data di inizio</th>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Data di completamento</th>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Durata(g)</th>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Ritardo(g)</th>
                                                 ...
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Realizzata(%)</th>
                                                 
                                                 <#if args.versions??>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Data di creazione</th>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Versione</th>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Creatore</th>
                                                 <th class="becpg_cellBorderLeft" style=" border-left: solid 1px black;border-collapse:collapse;border-spacing:1px;padding: 2px;">Osservazione</th>
                                                 <#--  <#else>
                                             ...
                                             <#else>
                                             <p><b> Nessun elemento trovato<b></p>
                                             </#if>
