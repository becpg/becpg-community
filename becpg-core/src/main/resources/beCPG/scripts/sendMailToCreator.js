...
if(document.properties["cm:creator"] != null &&
		people.getPerson(document.properties["cm:creator"]) != null &&
		people.getPerson(document.properties["cm:creator"]).properties["cm:email"] != null){
	// create mail action
