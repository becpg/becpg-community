                              ...
                              <td style="padding: 10px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      Buenos dias,
                                        ...
                                        <p>La hoja de producto <b>${document.name}</b> está disponible a continuación  </p>
                                        <a href="${document.shareUrl}"><button ><b>Ver ficha de producto</b></button></a>
                                        <p style="margin-bottom:0px;padding-bottom:0px">Atentamente,<br/>
                                        beCPG</p>
