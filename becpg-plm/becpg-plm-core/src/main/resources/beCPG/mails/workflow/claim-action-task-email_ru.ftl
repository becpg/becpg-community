                                    ...
                                    <tr>
                                       <td>
                                             ...
                                             <tr>
                                               ...
                                               <div>
                                                      <#if args.workflowPooled == true>
                                                         <p class="title" style="margin-bottom:0px;margin-top:5px;font-size: 20px; color: #0f515f; font-weight: bold;">Новая общая задача</p>
                                                      <#else>
                                                            <p class="title" style="margin:0px;font-size: 20px; color: #0f515f; font-weight: bold;">Вам поставили задачу</p>
                                                      </#if>
                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 0px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             ...
                                             <p>
                                                <#if args.workflowPooled == true>
                                                   Можно получить следующую общую задачу :
                                                <#else>
                                                    Вам было поручено следующее задание :
                                                </#if>
                                             </p>
