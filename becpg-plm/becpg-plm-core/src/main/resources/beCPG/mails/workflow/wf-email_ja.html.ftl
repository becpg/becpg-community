                                       ...
                                       <td>
                                                ...
                                                <td class="flex">
                                                   <img class= "img" src="${shareUrl}/res/components/images/project-email-logo.png" alt="" height="64" border="0"/>
                                                     <#if args.workflowPooled == true>
                                                            <p class="title" style="font-size: 20px; color: #0f515f; font-weight: bold;">新しい共有タスク</p>
                                                         <#else>
                                                            <p class="title" style="font-size: 20px; color: #0f515f; font-weight: bold;">タスクが割り当てられました</p>
                                                      </#if>
                                                </td>
                                             </tr>
                                          </table>
                                          <div style="font-size: 14px; margin: 12px 0px 0px 0px; padding-top: 10px; border-top: 1px solid  #a1a8aa;">
                                             <#if (args.workflowDescription)??>                                             
                                                ...
                                                <#if (args.workflowDueDate)??>締め切り :&nbsp;&nbsp;<b><red>${args.workflowDueDate?date?string.full}</red></b><br></#if>
                                                ...
                                                <#if hasRefused??>
                                                   <h3 style="color:#EC6535">拒否されたタスクとコメント</h3>
                                                      ...
                                                      <b>${item.properties["pjt:tlTaskName"]}</b>
                                                         <#if item.properties["pjt:tlState"]=="Refused">
                                                         <span class="state" style="background-color:#EC6535">拒否されました</span>
                                                         <#elseif item.properties["pjt:tlState"]=="Cancelled">
                                                         <span class="state" style="background-color:#FF0000">キャンセル</span>
                                                         <#elseif item.properties["pjt:tlState"]=="Completed">
                                                         <span class="state" style="background-color:#0F4454">終了しました</span>
                                                          <#elseif item.properties["pjt:tlState"]=="Planned">
                                                         <span class="state" style="background-color:#708090">計画</span>
                                                         <#elseif item.properties["pjt:tlState"]=="OnHold">
                                                         <span class="state" style="background-color:#0000CD">待っている</span>
                                                         </p>
                                                         </#if>
