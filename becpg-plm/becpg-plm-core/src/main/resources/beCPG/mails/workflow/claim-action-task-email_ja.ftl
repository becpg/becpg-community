                                             ...
                                             <tr>
                                               ...
                                               <div>
                                                      <#if args.workflowPooled == true>
                                                         <p class="title" style="margin-bottom:0px;margin-top:5px;font-size: 20px; color: #0f515f; font-weight: bold;">新しい共有タスク</p>
                                                      <#else>
                                                            <p class="title" style="margin:0px;font-size: 20px; color: #0f515f; font-weight: bold;">タスクが割り当てられました</p>
                                                      </#if>
