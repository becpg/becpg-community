                           ...
                           <tr>
                              <td style="padding: 10px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                     ...
                                     <p> Merhaba,<br />
                                      Uygunsuzluk üzerinde çalışmak üzere görevlendirildiniz <b>${nc.properties["bcpg:code"]!""}</b></p>
                                        

                                       <p><b>Açıklama :</b> ${nc.properties["cm:description"]!""}<br />
                                       <b>Durum :</b> ${nc.properties["qa:ncState"]!""}
                                       </p>
