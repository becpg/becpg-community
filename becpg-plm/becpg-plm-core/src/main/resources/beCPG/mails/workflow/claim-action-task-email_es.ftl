                                    ...
                                    <tr>
                                       <td>
                                             ...
                                             <tr>
                                               ...
                                               <div>
                                                      <#if args.workflowPooled == true>
                                                         <p class="title" style="margin-bottom:0px;margin-top:5px;font-size: 20px; color: #0f515f; font-weight: bold;">Nueva tarea compartida</p>
                                                      <#else>
                                                            <p class="title" style="margin:0px;font-size: 20px; color: #0f515f; font-weight: bold;">Se te ha asignado una tarea</p>
                                                      </#if>
                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 0px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             ...
                                             <p>
                                                <#if args.workflowPooled == true>
                                                   Se puede recuperar la siguiente tarea compartida :
                                                <#else>
