                                    ...
                                    <tr>
                                       <td>
                                             ...
                                             <tr>
                                               ...
                                               <div>
                                                      <#if args.workflowPooled == true>
                                                         <p class="title" style="margin-bottom:0px;margin-top:5px;font-size: 20px; color: #0f515f; font-weight: bold;">Ny delad uppgift</p>
                                                      <#else>
                                                            <p class="title" style="margin:0px;font-size: 20px; color: #0f515f; font-weight: bold;">Du har tilldelats en uppgift</p>
                                                      </#if>
                                          ...
                                          <div style="font-size: 14px; margin: 12px 0px 0px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                             ...
                                             <p>
                                                <#if args.workflowPooled == true>
                                                   Följande delade uppgift kan hämtas :
                                                <#else>
                                                    Du har tilldelats följande uppgift :
                                                </#if>
                                             </p>
