                           ...
                           <tr>
                              <td style="padding: 10px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                     ...
                                     <p> Merhaba,<br />
                                      Uyumsuzluk <b>${nc.properties["bcpg:code"]!""}</b> tarafından güncellendi <span style="color:#ff642d; font-weigth:bold">${person.properties["cm:firstName"]!""} ${person.properties["cm:lastName"]!""}</span>.</p>
                                        

                                       <p><b>Description :</b> ${nc.properties["cm:description"]!""}<br />
                                       <b>Durum :</b> ${nc.properties["qa:ncState"]!""}<br />
                                       <b>Yorum Yap :</b> ${ncComment!""}
                                       </p>
