                           ...
                           <tr>
                              <td style="padding: 10px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                     ...
                                     <p> こんにちは<br />
                                      コンプライアンス違反 <b>${nc.properties["bcpg:code"]!""}</b> によって更新されました <span style="color:#ff642d; font-weigth:bold">${person.properties["cm:firstName"]!""} ${person.properties["cm:lastName"]!""}</span>.</p>
                                        

                                       <p><b>説明 :</b> ${nc.properties["cm:description"]!""}<br />
                                       <b>状態 :</b> ${nc.properties["qa:ncState"]!""}<br />
                                       <b>コメント :</b> ${ncComment!""}
                                       </p>
