                                     		...
                                     		<#if args??>
	                                             ...
	                                             <tr>
                                                     ...
                                                     <p class ="title" style="margin-top:5px">
                                                        ...
                                                        <span style="margin:0px;font-size: 20px; color: #0f515f; font-weight: bold;">Ny delad uppgift</span><br/>
                                                        <#else>
                                                        <span style="margin:0px;font-size: 20px; color: #0f515f; font-weight: bold;">Du har tilldelats en uppgift</span><br/>
                                                        </#if>
	                                          ...
	                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
	                                             ...
	                                             <#if args.workflowTitle??>
	                                            	 <p style="font-size:16px">Uppgift : <b style="color: #0f515f">${args.workflowTitle}</b></p>
	                                             </#if>
	                                             
	                                             <#if (args.workflowDescription)??>                                             
	                                             	<p>Beskrivning : ${args.workflowDescription}</p>                                             
	                                             </#if>
	                                             
	                                             <p>
	                                                <#if (args.workflowDueDate)??>Förfallodatum :&nbsp;&nbsp;<b>${args.workflowDueDate?date?string.full}</b><br></#if>
	                                                ...
	                                                <a href="${shareUrl}/page/task-edit?taskId=${args.workflowId}"><button ><b>Visa uppgift</b></button></a>                       
	                                          </div>
                                       	<#else>
                                       	  	<table width="100%" cellpadding="0" cellspacing="0" border="0">
	                                             <tr>
	                                          ...
	                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
	                                             ...
	                                             Du har fått en produktvalideringsbegäran.
