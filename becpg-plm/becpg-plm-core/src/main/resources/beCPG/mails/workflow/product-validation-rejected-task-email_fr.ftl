                                     		...
                                     		<#if args??>
	                                             ...
	                                             <tr>
                                                     ...
                                                     <p class ="title" style="margin-top:5px">
                                                        ...
                                                        <span style="margin:0px;font-size: 20px; color: #0f515f; font-weight: bold;">Nouvelle tâche partagée</span><br/>
                                                        <#else>
                                                        <span style="margin:0px;font-size: 20px; color: #0f515f; font-weight: bold;">Une tâche vous a été assignée</span><br/>
                                                        </#if>
	                                          ...
	                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
	                                             ...
	                                             <#if args.workflowTitle??>
	                                            	 <p style="font-size:16px">Tâche : <b style="color: #0f515f">${args.workflowTitle}</b></p>
	                                             </#if>
	                                             ...
	                                             <p>
	                                                ...
	                                                <a href="${shareUrl}/page/task-edit?taskId=${args.workflowId}"><button ><b>Voir la tâche</b></button></a>                       
	                                          </div>
                                       	<#else>
                                       	  	<table width="100%" cellpadding="0" cellspacing="0" border="0">
	                                             <tr>
	                                          ...
	                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
	                                             ...
	                                             La demande de Validation Produit a été refusée.
