                           ...
                           <tr>
                              <td style="padding: 10px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                     ...
                                     <p> Bonjour,<br />
                                      La non-conformité <b>${nc.properties["bcpg:code"]!""}</b> a été mise à jour par <span style="color:#ff642d; font-weigth:bold">${person.properties["cm:firstName"]!""} ${person.properties["cm:lastName"]!""}</span>.</p>
                                        

                                       <p><b>Description :</b> ${nc.properties["cm:description"]!""}<br />
                                       <b>Etat :</b> ${nc.properties["qa:ncState"]!""}<br />
                                       <b>Commentaire :</b> ${ncComment!""}
                                       </p>
