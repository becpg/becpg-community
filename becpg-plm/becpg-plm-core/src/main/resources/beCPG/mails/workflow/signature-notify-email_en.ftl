                                             ...
                                             <tr>
                                                <td class="flex">
                                                   <img class= "img" src="${shareUrl}/res/components/images/project-email-logo.png" alt="" height="64" border="0"/>
                                                    <p class="title" style="font-size: 20px; color: #0f515f; font-weight: bold;">Document signature completed</p>
                                                </td>
                                             </tr>
                                          </table>
                                          <div style="font-size: 14px; margin: 12px 0px 0px 0px; padding-top: 10px; border-top: 1px solid  #a1a8aa;">
                                             <#if (args.documentName)??>                                             
                                             	<p>Signed document :&nbsp;&nbsp;<b>${args.documentName}</b></p>
                                                </#if>
                                             ...
                                             <a href="${shareUrl}/s/${args.shareId}"><button ><b>Display</b></button></a>  
