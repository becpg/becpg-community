                                     		...
                                     		<#if args??>
	                                             ...
	                                             <tr>
                                                     ...
                                                     <p class ="title" style="margin-top:5px">
                                                        ...
                                                        <span style="margin:0px;font-size: 20px; color: #0f515f; font-weight: bold;">新しい共有タスク</span><br/>
                                                        <#else>
                                                        <span style="margin:0px;font-size: 20px; color: #0f515f; font-weight: bold;">タスクが割り当てられました</span><br/>
                                                        </#if>
	                                          ...
	                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
	                                             ...
	                                             <#if args.workflowTitle??>
	                                            	 <p style="font-size:16px">仕事 : <b style="color: #0f515f">${args.workflowTitle}</b></p>
	                                             </#if>
	                                             
	                                             <#if (args.workflowDescription)??>                                             
	                                             	<p>説明 : ${args.workflowDescription}</p>                                             
	                                             </#if>
	                                             
	                                             <p>
	                                                <#if (args.workflowDueDate)??>締め切り :&nbsp;&nbsp;<b>${args.workflowDueDate?date?string.full}</b><br></#if>
	                                                ...
	                                                <a href="${shareUrl}/page/task-edit?taskId=${args.workflowId}"><button ><b>タスクを表示</b></button></a>                       
	                                          </div>
                                       	<#else>
                                       	  	<table width="100%" cellpadding="0" cellspacing="0" border="0">
	                                             <tr>
