                                             ...
                                             <tr>
                                                <td class="flex" >
                                                   <img class= "img" src="${shareUrl}/res/components/images/project-email-logo.png" alt="" height="64" border="0"/>
                                                         <p class="title" style="font-size: 20px; color: #004254; font-weight: bold;"> 仕事 Adhoc</p>
                                                </td>
                                             </tr>
                                          </table>
                                          <div style="font-size: 14px; margin: 12px 0px 0px 0px; padding-top: 10px; border-top: 1px solid  #a1a8aa;";">
                                             	 <p>こんにちは<br />
                                          <b style="color:#ff642d">${person.properties["cm:firstName"]!""} ${person.properties["cm:lastName"]!""}</b> あなたが彼に送ったAdhocタスクを完了しました
                                          </p>
