                                     		...
                                     		<#if args??>
	                                             ...
	                                             <tr>
                                                     ...
                                                     <p class ="title" style="margin-top:5px">
                                                        ...
                                                        <span style="margin:0px;font-size: 20px; color: #0f515f; font-weight: bold;">Nueva tarea compartida</span><br/>
                                                        <#else>
                                                        <span style="margin:0px;font-size: 20px; color: #0f515f; font-weight: bold;">Se te ha asignado una tarea</span><br/>
                                                        </#if>
	                                          ...
	                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
	                                             ...
	                                             <#if args.workflowTitle??>
	                                            	 <p style="font-size:16px">Tarea : <b style="color: #0f515f">${args.workflowTitle}</b></p>
	                                             </#if>
	                                             
	                                             <#if (args.workflowDescription)??>                                             
	                                             	<p>Descripción : ${args.workflowDescription}</p>                                             
	                                             </#if>
	                                             
	                                             <p>
	                                                <#if (args.workflowDueDate)??>Fecha de vencimiento :&nbsp;&nbsp;<b>${args.workflowDueDate?date?string.full}</b><br></#if>
	                                                ...
	                                                <a href="${shareUrl}/page/task-edit?taskId=${args.workflowId}"><button ><b>Ver tarea</b></button></a>                       
	                                          </div>
                                       	<#else>
                                       	  	<table width="100%" cellpadding="0" cellspacing="0" border="0">
	                                             <tr>
	                                          ...
	                                          <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
	                                             ...
	                                             Ha recibido una solicitud de validación de producto.
