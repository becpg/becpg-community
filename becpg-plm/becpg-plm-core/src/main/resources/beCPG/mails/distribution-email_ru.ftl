                              ...
                              <td style="padding: 10px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      Привет,
                                        ...
                                        <p>Лист продукта <b>${document.name}</b> доступно ниже  </p>
                                        <a href="${document.shareUrl}"><button ><b>См. Лист продукта</b></button></a>
                                        <p style="margin-bottom:0px;padding-bottom:0px">Привет,<br/>
                                        beCPG</p>
