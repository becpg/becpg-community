                              ...
                              <td style="padding: 10px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      Buongiorno,
                                        ...
                                        <p>La scheda prodotto <b>${document.name}</b> è disponibile di seguito  </p>
                                        <a href="${document.shareUrl}"><button ><b>Vedi la scheda prodotto</b></button></a>
                                        <p style="margin-bottom:0px;padding-bottom:0px">Cordiali saluti,<br/>
                                        beCPG</p>
