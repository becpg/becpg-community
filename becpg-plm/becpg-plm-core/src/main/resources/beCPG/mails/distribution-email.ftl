                              ...
                              <td style="padding: 10px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      Hello,
                                        ...
                                        <p>The product sheet <b>${document.name}</b> is available below  </p>
                                        <a href="${document.shareUrl}"><button ><b>See the product sheet</b></button></a>
                                        <p style="margin-bottom:0px;padding-bottom:0px">Regards,<br/>
                                        beCPG</p>
