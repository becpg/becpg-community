                              ...
                              <td style="padding: 10px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      Hallo,
                                        ...
                                        <p>Das Produktblatt <b>${document.name}</b> ist unten verfügbar  </p>
                                        <a href="${document.shareUrl}"><button ><b>Siehe Produktblatt</b></button></a>
                                        <p style="margin-bottom:0px;padding-bottom:0px">Schöne Grüße,<br/>
                                        beCPG</p>
