                              ...
                              <td style="padding: 10px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      Merhaba,
                                        ...
                                        <p>Ürün sayfası <b>${document.name}</b> aşağıda mevcuttur  </p>
                                        <a href="${document.shareUrl}"><button ><b>Ürün sayfasına bakın</b></button></a>
                                        <p style="margin-bottom:0px;padding-bottom:0px">candan,<br/>
                                        beCPG</p>
