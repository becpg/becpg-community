            ...
            <tr>
              <td style="padding: 20px;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    ...
                    <td valign="middle" style="padding-left: 10px;">
                      <p style="font-size: 20px; color: #004254; font-weight: bold; margin: 0;">Аккаунт beCPG</p>
                    </td>
                  </tr>
                </table>
                ...
                <p style="color:#004254; font-size:18px; font-weight:bold; margin: 0 0 10px 0;">
                  Здравствуйте, ${person.properties["cm:firstName"]!""},
                </p>
                ...
                <!-- Account Info -->
                <p style="margin: 10px 0;"><b>Аккаунт:</b> ${username}</p>
                <p style="margin: 10px 0;"><b>Пароль:</b> ${password}</p>

                <!-- Browser advice -->
                <p style="margin: 10px 0;">
                  Рекомендуем использовать браузеры Firefox или Chrome.
                </p>

                <!-- Documentation Links -->
                <p style="margin: 10px 0;">
                  Ознакомьтесь с нашей онлайн-документацией, чтобы начать работу с beCPG:
                </p>
                <ul style="padding-left: 20px; margin: 10px 0;">
                  <li><a href="https://docs.becpg.fr/en/tutorial/tutorial.html">Руководство по созданию продукта и его состава</a></li>
                  <li><a href="https://docs.becpg.fr/en/utilization/navigation-becpg.html">Документация по использованию beCPG</a></li>
                  <li><a href="https://docs.becpg.fr/en/utilization/project-management.html">Документация по управлению проектами</a></li>
                </ul>
                ...
                <p style="font-size: 13px; margin: 10px 0;">
                  Подробнее о beCPG вы можете узнать на сайте 
                ...
                <!-- Footer Logo -->
                <img src="${mailLogoUrl}" alt="Логотип beCPG" style="display: block; padding: 10px 0;" />
              </td>
            </tr>
          </table>
        </td>
