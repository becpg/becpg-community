                              ...
                              <td style="padding: 10px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      Bonjour,
                                        ...
                                        <p>La fiche produit <b>${document.name}</b> est disponible ci-dessous  </p>
                                        <a href="${document.shareUrl}"><button ><b>Voir la fiche produit</b></button></a>
                                        <p style="margin-bottom:0px;padding-bottom:0px">Cordialement,<br/>
                                        beCPG</p>
