                              ...
                              <td style="padding: 10px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                      ...
                                      Hei,
                                        ...
                                        <p>Tuotesivu <b>${document.name}</b> on saatavana alla  </p>
                                        <a href="${document.shareUrl}"><button ><b>Katso tuotesivu</b></button></a>
                                        <p style="margin-bottom:0px;padding-bottom:0px">sydämellisesti,<br/>
                                        beCPG</p>
