...
INSERT INTO alf_qname (ns_id,version,local_name) SELECT id,0, 'labelingLabelingTemplate' FROM alf_namespace WHERE uri = 'http://www.bcpg.fr/model/quality/1.0' ;
INSERT INTO alf_qname (ns_id,version,local_name) SELECT id,0, 'productMicrobioCriteriaRef' FROM alf_namespace WHERE uri = 'http://www.bcpg.fr/model/becpg/1.0';
INSERT INTO alf_qname (ns_id,version,local_name) SELECT id,0, 'precautionOfUseRef' FROM alf_namespace WHERE uri = 'http://www.bcpg.fr/model/becpg/1.0';
INSERT INTO alf_qname (ns_id,version,local_name) SELECT id,0, 'subsidiaryRef' FROM alf_namespace WHERE uri = 'http://www.bcpg.fr/model/becpg/1.0';
INSERT INTO alf_qname (ns_id,version,local_name) SELECT id,0, 'trademarkRef' FROM alf_namespace WHERE uri = 'http://www.bcpg.fr/model/becpg/1.0';
INSERT INTO alf_qname (ns_id,version,local_name) SELECT id,0, 'storageConditionsRef' FROM alf_namespace WHERE uri = 'http://www.bcpg.fr/model/becpg/1.0';
