...
public class PlmRepoConsts {
	...
	/** Constant <code>PATH_TRADEMARK_TYPES="TrademarkTypes"</code> */
	public static final String PATH_TRADEMARK_TYPES = "TrademarkTypes";
	/** Constant <code>PATH_NUT_GROUPS="NutGroups"</code> */
	public static final String PATH_NUT_GROUPS = "NutGroups";
	/** Constant <code>PATH_NUT_TYPES="NutTypes"</code> */
	...
	/** Constant <code>PATH_ORGANOS="Organos"</code> */
	public static final String PATH_ORGANOS = "Organos";
	/** Constant <code>PATH_ALLERGENS="Allergens"</code> */
	...
	/** Constant <code>PATH_PROCESSSTEPS="ProcessSteps"</code> */
	...
	/** Constant <code>PATH_PRECAUTION_OF_USE="PrecautionOfUse"</code> */
	public static final String PATH_PRECAUTION_OF_USE = "PrecautionOfUse";
	/** Constant <code>PATH_LABELING_TEMPLATES="LabelingTemplates"</code> */
	public static final String PATH_LABELING_TEMPLATES = "LabelingTemplates";
	/** Constant <code>PATH_LABELING_POSITIONS="LabelingPositions"</code> */
	...
	/** Constant <code>PATH_IMPORT_LOG="ImportLog"</code> */
	public static final String PATH_IMPORT_LOG = "ImportLog";
	/** Constant <code>PATH_IMPORT_USER="ImportUser"</code> */
	public static final String PATH_IMPORT_USER = "ImportUser";
	/** Constant <code>PATH_IMPORT_SAMPLES="ImportSamples"</code> */
	...
	public static final String PATH_REPORTS_EXPORT_SEARCH_INGLIST = "";
	...
	/** Constant <code>PATH_CONFIG="Config"</code> */
	public static final String PATH_CONFIG = "Config";
	/** Constant <code>PATH_WORKFLOW_SCRIPTS="WorkflowScripts"</code> */
