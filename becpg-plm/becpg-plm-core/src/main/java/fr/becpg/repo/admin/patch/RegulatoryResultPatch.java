...
public class RegulatoryResultPatch extends AbstractBeCPGPatch {
	...
	protected String applyInternal() throws Exception {
		...
		BatchProcessor<NodeRef> batchProcessor = new BatchProcessor<>("RegulatoryResultPatch", transactionService.getRetryingTransactionHelper(),
		...
		BatchProcessWorker<NodeRef> worker = new BatchProcessWorker<>() {
			...
			public void process(NodeRef nodeRef) throws Throwable {
				...
				if (nodeService.exists(nodeRef)) {
					...
					} else if ("Not listed".equals(result) || "Non listé".equals(result)) {
