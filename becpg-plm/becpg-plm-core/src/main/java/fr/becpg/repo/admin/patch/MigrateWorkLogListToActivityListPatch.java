	...
	protected String applyInternal() throws Exception {
		...
		for (NodeRef ncNodeRef : ncList) {
			...
			for(ChildAssociationRef wlNodeRef : wlAssocListRefs){
				...
				String wlState = (String) nodeService.getProperty(wlNodeRef.getChildRef(), QName.createQName("http://www.bcpg.fr/model/quality/1.0", "wlState"));
				String wlComment = (String) nodeService.getProperty(wlNodeRef.getChildRef(), QName.createQName("http://www.bcpg.fr/model/quality/1.0", "wlComment"));
