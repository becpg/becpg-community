						...
						if (listNodeRef != null) {
							...
							for (NodeRef dataListNodeRef : nuts) {
								...
								if (!Boolean.TRUE.equals(nodeService.getProperty(dataListNodeRef, BeCPGModel.PROP_IS_MANUAL_LISTITEM))) {
									...
									nodeService.setProperty(dataListNodeRef, PLMModel.PROP_NUTLIST_FORMULATED_MINI, nodeService.getProperty(dataListNodeRef, PLMModel.PROP_NUTLIST_MINI));
									nodeService.setProperty(dataListNodeRef, PLMModel.PROP_NUTLIST_MINI, null);
									nodeService.setProperty(dataListNodeRef, PLMModel.PROP_NUTLIST_FORMULATED_MAXI, nodeService.getProperty(dataListNodeRef, PLMModel.PROP_NUTLIST_MAXI));
									nodeService.setProperty(dataListNodeRef, PLMModel.PROP_NUTLIST_MAXI, null);
