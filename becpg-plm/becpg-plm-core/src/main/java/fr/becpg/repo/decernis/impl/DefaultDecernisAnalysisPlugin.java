...
@Service
public class DefaultDecernisAnalysisPlugin extends AbstractDecernisAnalysisPlugin {
	...
	public boolean isEnabled() {
		return (this.analysisUrl == null || analysisUrl.equals(serverUrl));
	}
	...
	@Override
	protected JSONObject postRecipeAnalysis(RegulatoryContext productContext, Set<String> countries, String usage, Integer moduleId) throws JSONException {
