...
public abstract class AbstractLabelingComponent extends BeCPGDataObject implements LabelingComponent, Comparable<LabelingComponent>, Cloneable {
	...
	protected <T extends AbstractLabelingComponent> List<T> clone(List<T> list) {
	...
	protected Map<NodeRef, AbstractLabelingComponent> clone(Map<NodeRef, AbstractLabelingComponent> list) {
		Map<NodeRef, AbstractLabelingComponent> ret = new LinkedHashMap<>();
		if (list != null) {
			for (Map.Entry<NodeRef, AbstractLabelingComponent> toAdd : list.entrySet()) {
	...
	public String toString() {
		return "AbstractLabelingComponent [qty=" + qty + ", volume=" + volume + ", legalName=" + legalName + ", nodeRef=" + nodeRef + ", name=" + name
				+ "]";
	}
