...
/**
 * <p>CollectionFormulationPlugin class.</p>
 *
 * @author matthieu
 * @version $Id: $Id
 */
@Service
public class CollectionFormulationPlugin implements FormulationPlugin {
	...
	public FormulationPluginPriority getMatchPriority(QName type) {
		return entityDictionaryService.isSubClass(type, PLMModel.TYPE_PRODUCTCOLLECTION) ? FormulationPluginPriority.NORMAL : FormulationPluginPriority.NONE;
