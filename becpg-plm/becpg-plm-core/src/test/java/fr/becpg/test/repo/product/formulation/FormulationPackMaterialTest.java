...
public class FormulationPackMaterialTest extends PLMBaseTestCase {

	private static final Log logger = LogFactory.getLog(FormulationPackMaterialTest.class);
	...
	public void testFormulationPackMaterial() throws Exception {
		...
		final NodeRef finishedProductNodeRef = transactionService.getRetryingTransactionHelper().doInTransaction(() -> {
				...
				packList.add(new PackagingListDataItem(null, 1d, ProductUnit.lb, PackagingLevel.Primary, true, packaging3NodeRef));// Fer 60 + 226.80 = 286.80 / Plastique = 80 + 226.8 = 306.8 
