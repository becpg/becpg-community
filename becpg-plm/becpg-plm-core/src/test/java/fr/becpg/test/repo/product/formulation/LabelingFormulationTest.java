...
public class LabelingFormulationTest extends AbstractFinishedProductTest {
	...
	public void testNullIng() throws Exception {
		...
		labelingRuleList.add(new LabelingRuleListDataItem("Param1", "detailsDefaultFormat = \"{0} {1,number,0.#%} ({2})\"", LabelingRuleType.Prefs,
				null, null));
		labelingRuleList.add(new LabelingRuleListDataItem("Aggr", null, LabelingRuleType.Group, Arrays.asList(rawMaterial13NodeRef,
				rawMaterial16NodeRef), null));
...
//			        └──[ing2 french - 4.0 ( vol : 4.0) ]
		...
		checkILL(finishedProductNodeRef1, labelingRuleList, "epaississant french: ing5 french 54,5% (ing1 french 70%, ing4 french 30%), epices french: ing6 french 45,5%",Locale.FRENCH);
...
//			        └──[ing2 french - 4.0 ( vol : 4.0) ]
		...
		checkILL(finishedProductNodeRef2, labelingRuleList, "epices french: ing6 french 95%, legal Raw material 1 (<b>allergen1</b>) 5%",Locale.FRENCH);
		...
		checkILL(finishedProductNodeRef3, labelingRuleList, "ing4 french 71,4%, epices french, legal Raw material 1 (<b>allergen1</b>) 8,6%",Locale.FRENCH);
	}
	...
	public void testCalculateILL() throws Exception {
		...
		labelingRuleList.add(new LabelingRuleListDataItem("Rendu", "render()", LabelingRuleType.Render));
		labelingRuleList.add(new LabelingRuleListDataItem("Declare", null, LabelingRuleType.Declare, Arrays.asList(localSF11NodeRef,
				rawMaterial12NodeRef, localSF12NodeRef), null));
		...
		labelingRuleList = new ArrayList<>();
		labelingRuleList.add(new LabelingRuleListDataItem("Rendu", "render()", LabelingRuleType.Render));
		labelingRuleList.add(new LabelingRuleListDataItem("Combine 1", new MLText("Comb 1"), "20,30", LabelingRuleType.Detail, Arrays.asList(ing1,
				ing2), null));
		labelingRuleList.add(new LabelingRuleListDataItem("%", "{0} {1,number,0.#%}", LabelingRuleType.Format, Arrays.asList(ing1, ing2, ing3, ing4),
				null));
		labelingRuleList.add(new LabelingRuleListDataItem("Param1", "detailsDefaultFormat = \"{0} {1,number,0.#%} ({2})\"", LabelingRuleType.Prefs,
		...
		labelingRuleList = new ArrayList<>();
		labelingRuleList.add(new LabelingRuleListDataItem("Rendu", "render()", LabelingRuleType.Render));
		labelingRuleList.add(new LabelingRuleListDataItem("Combine 1", new MLText("Comb 1"), "100,30", LabelingRuleType.Detail, Arrays.asList(ing1,
				ing2), null));
		labelingRuleList.add(new LabelingRuleListDataItem("%", "{0} {1,number,0.#%}", LabelingRuleType.Format, Arrays.asList(ing1, ing2, ing3, ing4),
				null));
		labelingRuleList.add(new LabelingRuleListDataItem("Param1", "detailsDefaultFormat = \"{0} {1,number,0.#%} ({2})\"", LabelingRuleType.Prefs,
		...
		labelingRuleList = new ArrayList<>();
		labelingRuleList.add(new LabelingRuleListDataItem("Rendu", "render()", LabelingRuleType.Render));
		labelingRuleList.add(new LabelingRuleListDataItem("Combine 2", new MLText("Decors 1"), null, LabelingRuleType.Group, Arrays.asList(
				localSF11NodeRef, localSF12NodeRef), null));
		labelingRuleList.add(new LabelingRuleListDataItem("Param1", "detailsDefaultFormat = \"{0} {1,number,0.#%} ({2})\"", LabelingRuleType.Prefs,
				null, null));
