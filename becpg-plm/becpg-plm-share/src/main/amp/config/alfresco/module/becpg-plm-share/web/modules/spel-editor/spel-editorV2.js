               ...
               Alfresco.component.Base,
               {
                  ...
                  _renderFormula : function SpelEditor__renderFormula(updateTextArea) {
                     ...
                     function itemsCallBack(response) {
                        ...
                        if (updateTextArea) {
                           Dom.get(instance.id + "-editor-textarea").value = instance.options.currentValue;
                           	...
                           	CodeMirror.commands.autocomplete = function(cm) {
                                ...
                                if (items != null) {
                                   for ( var i = 0, il = items.length; i < il; i++) {
                                      ...
                                      var searchCursor = instance.widgets.editor.getSearchCursor(item.nodeRef);
           
                                      while(searchCursor.findNext()){
                                   	   var span = document.createElement('span');
                                   	   span.innerHTML =$html(item.name);
                                   	   instance.widgets.editor.markText(searchCursor.from(), searchCursor.to(), {replacedWith:span } );
                                      }
