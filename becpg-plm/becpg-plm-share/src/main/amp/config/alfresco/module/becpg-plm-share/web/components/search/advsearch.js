...
(function()
{
    ...
    {
        Alfresco.AdvancedSearch.superclass.constructor.call(this, "Alfresco.AdvancedSearch", htmlId, [ "button",
                "container" ]);
            ...
            .extend(
                    ...
                    Alfresco.component.Base,
                    {
                        ...
                        options :
                        {
                            ...
                            /**
                             * Search Form objects, for example: { id:
                             * "advanced-search", type: "cm:content", label:
                             * "Content", description: "All types of content" }
                             * 
                            ...
                            /**
                             * It is possible to disable searching entire repo
                             * via config
                             * 
                             * @property searchScope - "repo" or "all_sites" or
                             *           a siteid
                             * @type string
                             */
                            searchScope : ""
                        ...
                        onReady : function ADVSearch_onReady()
                        {
                            ...
                            if (Dom.get(this.id + "-adv-search-button") != null)
                            {
                            ...
                            this.widgets.searchButton1 = Alfresco.util.createYUIButton(this, "search-button-1",
                                    this.onSearchClick);
                            this.widgets.searchButton2 = Alfresco.util.createYUIButton(this, "search-button-2",
                                    this.onSearchClick);

                            this.widgets.formButton = Alfresco.util.createYUIButton(this, "selected-form-button",
                                    function(p_sType, p_aArgs)
                                    {
                                        // update selected item menu button
                                        // label
                                        var form = this.options.searchForms[p_aArgs[1].index];
                                        this.widgets.formButton.set("label",
                                                form.label + " " + Alfresco.constants.MENU_ARROW_SYMBOL);
                                        this.widgets.formButton.set("title", form.description);

                                        if (form.type == null)
                                        {
                                            if (this.widgets.formPanel != null)
                                            {
                                                this.widgets.formPanel.set("disabled", true);
                                            }
                        ...
                        /**
                         * Loads or retrieves from cache the Form template for a
                         * given content type
                         * 
                         * @method renderFormTemplate
                         * @param form
                         *            {Object} Form descriptor to render
                         *            template for
                         * @param repopulate
                         *            {boolean} If true, repopulate form
                         *            instance based on supplied data
                         */
                        renderFormTemplate : function ADVSearch_renderFormTemplate(form, repopulate)
                        {
                            ...
                            var visibleFormFn = function()
                            {
                                ...
                                if (me.widgets.formPanel != null)
                                {
                                    me.widgets.formPanel.set("disabled", false);
                                }
                            ...
                            if (!form.htmlid)
                            {
                                ...
                                // cache htmlid so we know the form is present
                                // on the form
                                form.htmlid = htmlid;
                                ...
                                var formUrl = YAHOO.lang
                                        .substitute(
                                                Alfresco.constants.URL_SERVICECONTEXT + "components/form?itemKind=type&itemId={itemId}&formId={formId}&mode=edit&showSubmitButton=false&showCancelButton=false",
                                                {
                                                    itemId : form.type,
                                                    formId : form.id
                                                });
                        ...
                        /**
                         * Repopulate currently displayed Form fields based on
                         * saved query data
                         * 
                                        ...
                                        if (savedValue !== undefined)
                                        {
                                            ...
                                            else if (name.match("-range$") == "-range")
                                            {
                                                ...
                                                if (cntrl)
                                                {
                                                    ...
                                                    cntrl.value = savedValue.substring(savedValue.indexOf("|") + 1,
                                                            savedValue.length);
                        ...
                        onSearchClick : function ADVSearch_onSearchClick(e, obj)
                        {
                            ...
                            {
                                // retrieve form data structure directly from
                                // the runtime
                                ...
                                url = YAHOO.lang
                                        .substitute(
                                                Alfresco.constants.URL_PAGECONTEXT + this.options.searchPath,
                                                {
                            ...
                            else
                            {
                                url = YAHOO.lang
                                        .substitute(
                                                Alfresco.constants.URL_PAGECONTEXT + "{site}search?t={terms}&r={repo}",
                                                {
                                                    site : (this.options.siteId.length !== 0 ? ("site/" + this.options.siteId + "/")
                                                            : ""),
                                                    terms : encodeURIComponent(Dom.get(this.id + "-search-text").value),
                        ...
                        onBeforeFormRuntimeInit : function ADVSearch_onBeforeFormRuntimeInit(layer, args)
                        {
                            ...
                            // remove Forms Runtime validators on the advanced
                            // search form
                        ...
                        /**
                         * Event handler called when the "afterFormRuntimeInit"
                         * event is received
                         */
