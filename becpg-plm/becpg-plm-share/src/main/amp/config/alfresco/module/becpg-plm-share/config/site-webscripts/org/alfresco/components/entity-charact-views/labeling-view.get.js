...
function main()
{
    ...
    model.widgets = model.widgets.concat(createDashlet("compoList-"+args.htmlid, "compoListDashlet",msg.get("dashlet.compoList.title"),"bcpg:compoList", false ,"compoList", "labeling", "&repo=true&guessContainer=true" ));
}
