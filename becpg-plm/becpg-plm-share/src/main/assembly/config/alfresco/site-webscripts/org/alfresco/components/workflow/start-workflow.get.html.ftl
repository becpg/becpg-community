<@markup id="css" >
   ...
   <@link href="${url.context}/res/components/process/start-process.css" group="workflow"/>
...
<@markup id="js">
   ...
   <@script src="${url.context}/res/components/process/start-process.js" group="workflow"/>
            ...
            <div id="${el}-workflow-definition-menu" class="yuimenu" style="visibility:hidden">
               <div class="bd">
                  <ul>
                     ...
                     <li>
                        <span class="title" tabindex="0">${workflowDefinition.title!workflowDefinition.itemId?html}</span>
