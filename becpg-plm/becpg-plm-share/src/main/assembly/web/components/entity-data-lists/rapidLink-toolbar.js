/***********************************************************************************************************************
 * Copyright (C) 2010-2026 beCPG. This file is part of beCPG beCPG is free software: you can redistribute it and/or
               ...
               beCPG.component.RapidLinkToolbar.prototype,
               {
                  ...
                  onReady : function RapidLinkToolbar_onReady() {
                     ...
                     if ("packagingList" == this.options.list) {
                        ...
                        createList = [ "finishedProduct", "rawMaterial", "semiFinishedProduct","localSemiFinishedProduct" ];
                     }
