 ...
 */
package fr.becpg.web.resolver.scripts;
...
import fr.becpg.web.resolver.doclib.DoclistActionGroupResolver;
...
{
    private static Log logger = LogFactory.getLog(ResolverHelper.class);
