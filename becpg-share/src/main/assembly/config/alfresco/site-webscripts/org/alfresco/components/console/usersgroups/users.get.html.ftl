...
<@markup id="html">
   <@uniqueIdDiv>
      ...
      <#assign contentLocale = config.scoped["Languages"]["languages"]>
      <#assign uiLocale = config.scoped["Languages"]["ui-languages"]>
      <div id="${el}-body" class="users">
         ...
         <div id="${el}-view" class="hidden">
            ...
            <div id="${el}-view-main" class="view-main separator">
               ...
               <!-- user locale -->
               <div class="field-row">
                  <span class="field-label-right"> ${msg("label.usercontentlocale")}:&nbsp; </span>
                  <span id="${el}-view-usercontentlocale" class="field-value"></span>
               </div>
               <div class="field-row">
