	...
	YAHOO.lang.augmentObject(beCPG.component.EntitySuggestions.prototype, {
		...
		launchSuggestions: function() {
			...
			if (!me.isIFrameLoaded) {
				...
				suggestionsDiv.innerHTML = '<iframe src="' + Alfresco.constants.URL_CONTEXT + 'proxy/ai/suggestions?ticket=' + me.options.ticket + '&nodeRef=' + me.options.entityNodeRef + '&locale=' + me.options.locale + '&frame=true" referrerpolicy="origin" sandbox="allow-scripts allow-same-origin allow-forms allow-popups allow-popups-to-escape-sandbox"></iframe>';
