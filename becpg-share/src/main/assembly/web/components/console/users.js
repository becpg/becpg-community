...
(function()
{
    ...
    * @return {beCPG.ConsoleUsers} The new ConsoleUsers instance
    * @constructor
    */
   beCPG.ConsoleUsers = function(htmlId)
   {
      this.name = "beCPG.ConsoleUsers";
      beCPG.ConsoleUsers.superclass.constructor.call(this, htmlId);
      ...
      YAHOO.extend(SearchPanelHandler, Alfresco.ConsolePanelHandler,
      {
         ...
         */
         ...
         _setDefaultDataTableErrors: function _setDefaultDataTableErrors(dataTable)
         {
            ...
            dataTable.set("MSG_EMPTY", parent._msg("message.empty", "beCPG.ConsoleUsers"));
            dataTable.set("MSG_ERROR", parent._msg("message.error", "beCPG.ConsoleUsers"));
         },
   ...
   YAHOO.extend(beCPG.ConsoleUsers, Alfresco.ConsoleTool,
   {
      /**
      ...
      onReady: function ConsoleUsers_onReady()
      {
         ...
         beCPG.ConsoleUsers.superclass.onReady.call(this);
      },
      ...
      _updateUser: function ConsoleUsers__updateUser(handler)
      {
         ...
         var personObj =
         {
            ...
            userLocale: fnGetter("-update-userlocale"),
            userContentLocale: fnGetter("-update-usercontentlocale")
         };
      ...
      {
         return Alfresco.util.message.call(this, messageId, "beCPG.ConsoleUsers", Array.prototype.slice.call(arguments).slice(1));
      }
   });
})();
