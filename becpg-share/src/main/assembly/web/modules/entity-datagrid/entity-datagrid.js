...
(function() {
    ...
    beCPG.module.EntityDataGrid = function(htmlId, scopeable) {
        ...
        Bubbling.on("changeSelectedColumns", this.onChangeSelectedColumns, this);
        ...
        .augmentObject(
            beCPG.module.EntityDataGrid.prototype,
            {
                ...
                onReady: function EntityDataGrid_onReady() {
                    ...
                    if (this.options.storePageSizeInPrefs) {
                        this.pageSize = Alfresco.util.findValueByDotNotation(this.services.preferences.get(), "fr.becpg.entityDataGrid." + this._getDataListName() + ".pageSize");
                    }
                ...
                populateFilterForm: function EntityDataGrid_populateFilterForm() {
                    if (!this.isFilterFormLoaded) {
                        var listName = this._getDataListName();
                    ...
                    for (var i = 0, ii = this.datalistColumns.length; i < ii; i++) {
                        ...
                        if ((column.dataType == "nested" || column.dataType == "nested_column") && column.columns) {
                            ...
                            for (var j = 0; j < column.columns.length; j++) {
                                ...
                                columnName += "|" + nestedColumn.name.replace(":", "_");
                            }
                ...
                _getDataListName: function() {
                    return this.datalistMeta.name != null ? this.datalistMeta.name
                        : this.options.list;
                },

                _getItemType: function() {
                    return this.options.itemType != null ? this.options.itemType
                ...
                _getPageSize: function() {
                    return this.pageSize != null ? this.pageSize : this.options.pageSize;
                },
                ...
                _setupDataTable: function EntityDataGrid__setupDataTable() {
                    ...
                    function createColumnDef(columnKey, column, sticky) {
                        var hidden = column.label == "hidden" || (beCPG.util.contains(
                            me.options.hiddenOnlyColumns, columnKey));
                        ...
                        var colDef = {
                            ...
                            sortOptions:
                            {
                                ...
                                sortFunction: me.rendererHelper.getSortFunction()
                            },
                            formatter: me.rendererHelper.getCellFormatter(me),
                            editor: me.options.saveFieldUrl != null ? me.rendererHelper.getCellEditor(
                                me, column, me.options.saveFieldUrl) : null
                        };
                    ...
                    if (this.options.usePagination) {
                        ...
                        this.widgets.paginator = new YAHOO.widget.Paginator(
                            {
                                ...
                                rowsPerPage: this._getPageSize(),
                                initialPage: this.options.initialPage,
                                template: this.msg("pagination.template") + " {RowsPerPageDropdown}",
                        ...
                        var handlePagination = function EntityDataGrid_handlePagination(state, me) {
                            ...
                            if (state.rowsPerPage != me._getPageSize()) {
                                me.pageSize = state.rowsPerPage;
                                if (me.options.storePageSizeInPrefs) {
                                    me.services.preferences.set("fr.becpg.entityDataGrid." + me._getDataListName(), { "pageSize": me.pageSize });
                                }
                            }
                    ...
                    this.widgets.dataTable.handleDataReturnPayload = function EntityDataGrid_handleDataReturnPayload(
                        ...
                        if (me.widgets.paginator) {
                            ...
                            me.widgets.paginator.set('rowsPerPage', me._getPageSize());

                            if (me.currentSort != null) {
                                me.widgets.dataTable.set("sortedBy", { key: me.currentSort, dir: me.currentSortDir });
                            }

                            if (oResponse.meta.totalRecords > me._getPageSize() || me._getPageSize() > me.options.pageSize) {
                ...
                onChangeSelectedColumns: function EntityDataGrid_onChangeSelectedColumns(layer, args) {
                    var obj = args[1];
