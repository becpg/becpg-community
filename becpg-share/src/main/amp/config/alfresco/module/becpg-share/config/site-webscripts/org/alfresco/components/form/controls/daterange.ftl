...
<div class="form-field">
   ...
   <div id="${controlId}" style="width:24em">
      <div class="yui-g date-range">
         <div class="yui-u first">
            <span>${msg("form.control.date-range.from")}:</span>
            <div>
               <#-- from date -->
               <input id="${controlId}-date-from" name="-" type="text" class="date-entry date-range" <#if field.description??>title="${field.description}"</#if> tabindex="0" />
         ...
         <div class="yui-u">
            ...
            <div>
               <#-- to date -->
               <input id="${controlId}-date-to" name="-" type="text" class="date-entry date-range" <#if field.description??>title="${field.description}"</#if> tabindex="0" />
