...
(function() {
    ...
    var Dom = YAHOO.util.Dom, Event = YAHOO.util.Event;
     ...
     YAHOO.widget.GroupedDataTable = function(elContainer, aColumnDefs, oDataSource, oConfigs) {
        ...
        YAHOO.widget.GroupedDataTable.superclass.constructor.call(this, elContainer, aColumnDefs, oDataSource, oConfigs);
    ...
    YAHOO.lang.extend(YAHOO.widget.GroupedDataTable, YAHOO.widget.DataTable, {
        /**
        ...
        */
        insertGroup: function(name, row) {
            ...
            // Set up DOM events
            if (name && name.length > 0) { // Only if the group has a value
        ...
        */
        ...
        getPreviousTrEl: function(row) {
            var currentRow = row;
            var previousRow = YAHOO.widget.GroupedDataTable.superclass.getPreviousTrEl.call(this, currentRow);
