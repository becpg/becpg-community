<#macro editorParameters field>
   <#if (field.control.params.editorAppearance)??><#assign appearance=field.control.params.editorAppearance><#else><#assign appearance="default"></#if>
   <#if (field.control.params.editorHeight)??><#assign height=field.control.params.editorHeight><#else><#assign height=100></#if>
   <#if (field.control.params.editorWidth)??><#assign width=field.control.params.editorWidth><#else><#assign width=400></#if>
