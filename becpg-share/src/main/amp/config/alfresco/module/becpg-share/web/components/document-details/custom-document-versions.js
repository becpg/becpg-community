/*******************************************************************************
 * Copyright (C) 2010-2014 beCPG. This file is part of beCPG beCPG is free
            ...
            .extend(
                    ...
                    Alfresco.DocumentVersions,
                    {
                        ...
                        options :
                        {
                            ...
                            /**
                             * The name of container that the node lives in,
                             * will be used when uploading new versions.
                             * 
                            ...
                            /**
                             * The version of the working copy (if it is a
                             * working copy), will be used during upload.
                             * 
                            ...
                            /**
                             * Tells if the user may upload a new version or
                             * revert the document.
                             * 
                            ...
                            /**
                             * Tells if the user may compare the version and the
                             * document.
                             * 
                             * @property isEntity
                             * @type string
                            ...
                            this.widgets.alfrescoDataTable = new Alfresco.util.DataTable(
                                    {
                                        dataSource :
                                        {
                                            ...
                                            {
                                                // Versions are returned in an
                                                // array but must be placed in
                                                // an object to be able to
                                                // be parse by yui
                                                // Also skip the first version
                                                // since that is the current
                                                // version
                                                ...
                                                // Cache the version data for
                                                // other components (e.g.
                                                // HistoricPropertiesViewer)
                        ...
                        /**
                         * Triggers the archiving and download of a single
                         * folders contents
                         * 
                         * @method onActionFolderDownload
                         * @param record
                         *            {object} Object literal representing the
                        ...
                        getDocumentVersionMarkup : function DocumentVersions_getDocumentVersionMarkup(doc)
                        {
                            ...
                            html += $userProfileLink(doc.creator.userName,
                                    doc.creator.firstName + ' ' + doc.creator.lastName, 'class="theme-color-1"') + ' ';
