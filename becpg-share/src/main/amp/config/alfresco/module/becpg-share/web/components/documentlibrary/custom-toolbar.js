                        ...
                        onReady : function CustomDLTB_onReady()
                        {
                            if (Dom.get(this.id + "-tb-body") != null)
                            {
                                ...
                                if (Dom.get(this.id + "-createContent-button"))
                                {
                                    ...
                                    this.widgets.createContent = Alfresco.util.createYUIButton(this,
                                            "createContent-button", this.onCreateContent,
                                            {
                                                type : "menu",
                                    ...
                                    if (this.options.createContentByTemplateEnabled)
                                    {
                                        ...
                                        li.innerHTML = '<a href="#"><span>' + this
                                                .msg("menu.create-content.by-template-node") + '</span></a>';

                                        // Make sure to stop clicks on the sub
                                        // menu link to close the entire menu
                                        YAHOO.util.Event.addListener(Selector.query("a", li, true), "click",
                                                function(e)
                                                {
                                        ...
                                        li2.innerHTML = '<a href="#"><span>' + this
                                                .msg("menu.create-content.by-template-folder") + '</span></a>';

                                        // Make sure to stop clicks on the sub
                                        // menu link to close the entire menu
                                        YAHOO.util.Event.addListener(Selector.query("a", li2, true), "click", function(
                                                e)
                                        {
                                            Event.preventDefault(e);
                                            Event.stopEvent(e);
                                        ...
                                        {
                                            templateNodesMenu.subscribe("beforeShow",
                                                    this.onCreateByTemplateNodeBeforeShow, this, true);
                                            templateNodesMenu.subscribe("click", this.onCreateByTemplateNodeClick,
                                                    this, true);
                                        }

                                        var templateFoldersMenu = templateNodesMenus.length > 1 ? templateNodesMenus[1]
                                                : null;
                                        if (templateFoldersMenu)
                                        {
                                            templateFoldersMenu.subscribe("beforeShow",
                                                    this.onCreateByTemplateFolderBeforeShow, this, true);
                                            templateFoldersMenu.subscribe("click", this.onCreateByTemplateFolderClick,
                                                    this, true);
                                        }
                                    }
                                ...
                                this.widgets.unsyncFromCloud = Alfresco.util.createYUIButton(this,
                                        "unsyncFromCloud-button", this.onUnsyncFromCloud,
                                        {
                                            disabled : true,
                                            value : "CreateChildren"
                                        });
                                ...
                                this.widgets.bulkEdit = Alfresco.util.createYUIButton(this, "bulkEdit-button",
                                        this.onBulkEdit,
                                        {
                                            disabled : false
                                        });
                                ...
                                this.widgets.selectedItems = Alfresco.util.createYUIButton(this,
                                        "selectedItems-button", this.onSelectedItems,
                                        {
                                            type : "menu",
                                ...
                                if (Dom.get(this.id + "hideNavBar-button"))
                                {
                                    ...
                                    if (this.widgets.hideNavBar !== null)
                                    {
                                        this.widgets.hideNavBar.set("title", this
                                                .msg(this.options.hideNavBar ? "button.navbar.show"
                                                        : "button.navbar.hide"));
                                ...
                                // current settings...
                                Dom
                                        .setStyle(this.id + "-navBar", "display", this.options.hideNavBar ? "none"
                                                : "block");
                                ...
                                this.widgets.folderUp = Alfresco.util.createYUIButton(this, "folderUp-button",
                                        this.onFolderUp,
                                        {
                                            disabled : true,
