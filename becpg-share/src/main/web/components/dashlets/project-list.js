/**
 * Dashboard ProjectList component.
 *
 * @namespace beCPG
 * @class beCPG.dashlet.ProjectList
 */
(function()
{
   /**
   ...
   */
    ...
    * Preferences
    */
   var PREFERENCES_ProjectList_DASHLET = "org.alfresco.share.projectlist.dashlet",
      PREFERENCES_ProjectList_DASHLET_FILTER = PREFERENCES_ProjectList_DASHLET + ".filter",
      PREFERENCES_ProjectList_DASHLET_VIEW = PREFERENCES_ProjectList_DASHLET + ".simpleView";
   

   /**
    * Dashboard ProjectList constructor.
    *
    * @param {String} htmlId The HTML id of the parent element
    * @return {beCPG.dashlet.ProjectList} The new component instance
    * @constructor
    */
   beCPG.dashlet.ProjectList = function ProjectList_constructor(htmlId)
   {
      return beCPG.dashlet.ProjectList.superclass.constructor.call(this, htmlId);
   };

   YAHOO.extend(beCPG.dashlet.ProjectList, Alfresco.component.SimpleDocList,
   {
   	searchTerm: null,
       ...
       * @method onReady
       */
      onReady: function ProjectList_onReady()
      {
         ...
         beCPG.dashlet.ProjectList.superclass.onReady.apply(this, arguments);
      },
       ...
       */
      getWebscriptUrl: function ProjectList_getWebscriptUrl()
      {
         return Alfresco.constants.PROXY_URI + "slingshot/doclib/doclist/project/node/alfresco/company/home?max=50";
      },
       ...
       * @override
       */
      getParameters: function ProjectList_getParameters()
      {
      	var parameters = "type=project&filter=" + this.widgets.filter.value;
       ...
       * @param p_aArgs {array}
       */
      onFilterChange: function ProjectList_onFilterChange(p_sType, p_aArgs)
      {
         ...
         if (menuItem)
         {
            ...
            this.services.preferences.set(PREFERENCES_ProjectList_DASHLET_FILTER, this.widgets.filter.value);
       ...
       */
      onSimpleDetailed: function ProjectList_onSimpleDetailed(e, p_obj)
      {
         this.options.simpleView = e.newValue.index === 0;
         this.services.preferences.set(PREFERENCES_ProjectList_DASHLET_VIEW, this.options.simpleView);
         if (e)
         {
      ...
      * @param oData {object|string}
      */
     renderCellDetail: function ProjectList_renderCellDetail(elCell, oRecord, oColumn, oData)
     {
       ...
       */
      configureSearch: function ProjectList_configureSearch()
      {
...
,
       ...
       */
      onSearchFocus: function ProjectList_onSearchFocus()
      {
       ...
       * @method onSearchBlur
       */
      onSearchBlur: function ProjectList_onSearchBlur()
      {
       ...
       */
      setDefaultSearchText: function ProjectList_setDefaultSearchText()
      {
       ...
       */
      getSearchText: function ProjectList_getSearchText()
      {	
       ...
       */
      onSearchChange: function ProjectList_onSearchChange()
      {
      ...
      onActionShowCharact: function ProjectList_onActionShowCharact(row) {
