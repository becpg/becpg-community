	...
	beCPG.component.beCPGAdminConsole = function(htmlId) {
		...
		YAHOO.extend(FormPanelHandler, Alfresco.ConsolePanelHandler, {
			...
			onLoad : function onLoad() {
				// Buttons
				parent.widgets.reloadModelButton = Alfresco.util.createYUIButton(parent, "reload-model-button",
						parent.onReloadModelClick);
				parent.widgets.reloadConfigButton = Alfresco.util.createYUIButton(parent, "reload-config-button",
						parent.onReloadConfigClick);
				parent.widgets.initRepoButton = Alfresco.util.createYUIButton(parent, "init-repo-button",
