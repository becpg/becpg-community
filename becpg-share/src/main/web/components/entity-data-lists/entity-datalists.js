	      ...
	      .extend(
	            ...
	            Alfresco.component.DataLists,
	            {
	               ...
	               onReady : function DataLists_onReady() {
		               ...
		               this.widgets.spinner.setBody('<div style="text-align:center;"><img src="'
	               ...
	               /**
						 ...
						 * @param callback
						 *           {Object} Optional callback literal {fn, scope,
						 *           obj} whose function is invoked once list has been
						 *           retrieved
						 */
	               ...
	               /**
						 ...
						 * @param highlightName
						 *           {String} Optional name of list to highlight after
						 *           rendering
						 */
	               renderDataLists : function DataLists_renderDataLists(p_highlightName) {
		               ...
		               try {
			               ...
			               if (this.dataListsLength === 0) {
				               listsContainer.innerHTML = '<div class="no-lists">' + this.msg("message.no-lists")
				                     + '</div>';
			               } else {
			               ...
			               listsContainer.innerHTML = '<span class="error">' + this.msg("message.error-unknown")
			                     + '</span>';
		               }
	               }
