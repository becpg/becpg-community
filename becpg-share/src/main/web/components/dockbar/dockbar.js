               ...
               Alfresco.component.Base,
               {
                  ...
                  main : function() {
                     ...
                     if (this.ns4) {
                        ...
                        this.currentY = (document.getElementById('floatLayer').style.top.length < 1 ? 0 : parseInt(
                              document.getElementById('floatLayer').style.top, 10));
                        if (this.originalY <= 0) {
                  ...
                  getLayerY : function(pobj) {
                     var curtop = 0, obj = pobj;
                     if (obj.offsetParent) {
                  ...
                  renderCellDetail : function DockBar_renderCellDetail(elCell, oRecord, oColumn, oData) {
                     ...
                     desc += '<span class="item-separator"><a class="view-documents" href="' + this
                           ._getDocumentsUrlForRecord(oRecord) + '" title="' + this
                           .msg("actions.entity.view-documents") + '" tabindex="0">' + this
                           .msg("actions.entity.view-documents.short") + '</a></span>';
                     desc += '<span class="item-separator"><a class="view-characts" href="' + this
                           ._getCharactUrlForRecord(oRecord) + '" title="' + this.msg("actions.entity.view-datalists") + '" tabindex="0">' + this
                  ...
                  renderCellThumbnail : function DockBar_renderCellThumbnail(elCell, oRecord, oColumn, oData) {
                     ...
                     var record = oRecord.getData(), thumbName = record.displayName;
                     ...
                     var imageUrl = beCPG.util.getFileIcon(thumbName, record, false, true);

                     // Render the cell
                     thumbName = oRecord.getData("displayName");
                     var htmlName = $html(thumbName);
                  ...
                  _getDocumentsUrlForRecord : function DockBar_getCharactUrlForRecord(record) {
                     var site = record.getData("site"), recordSiteName =  site && site !== null && $isValueSet(site.shortName) ? site.shortName
