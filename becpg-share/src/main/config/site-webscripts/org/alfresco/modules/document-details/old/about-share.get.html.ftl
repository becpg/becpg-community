   ...
   <div class="bd">
      <div id="${el}-logo" class="${aboutConfig.getChildValue("css-class")!logo-com} logo">
         <div class="about">
            ...
            <div class="header">beCPG with Alfresco ${serverEdition?html} v${serverVersion?substring(0, split)?html}</div>
            ...
            <div class="copy padtop">&copy; 2005-2012 Alfresco Software Inc. All rights reserved.</div>
            <div class="copy">
