...
/**
 * Finds the configuration for the given item id, if there isn't any configuration for the item null is returned.
 * 
 * @method getFormConfig
 * @param itemId
 *            The id of the item to retrieve for config for
 * @param formId
 *            The id of the specific form to lookup or null to get the default form
...
/**
 * Returns the list of fields configured to be visible for the given mode. If this method returns null or an empty list
 * the component should attempt to display ALL known data for the item, unless there are fields configured to be hidden.
 * 
...
/**
 * Creates an Object to represent the body of the POST request to send to the form service.
 * 
